...
# USAGE
    python azure_large_instance_create.py
...
def main():
    ...
    response = client.azure_large_instances.create(
        resource_group_name="myResourceGroup",
        azure_large_instance_name="myALInstance",
        azurelargeinstanceproperties={
            "location": "westus2",
            "properties": {"hardwareProfile": {"azureLargeInstanceSize": "S72", "hardwareType": "Cisco_UCS"}},
            "tags": {"key": "value"},
        },
    )
    print(response)
