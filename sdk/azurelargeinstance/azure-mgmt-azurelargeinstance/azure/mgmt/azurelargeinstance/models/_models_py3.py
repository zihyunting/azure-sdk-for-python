...
class HardwareProfile(_serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        azure_large_instance_size: Optional[Union[str, "_models.AzureLargeInstanceSizeNamesEnum"]] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :paramtype hardware_type: str or
         ~azure.mgmt.azurelargeinstance.models.AzureLargeInstanceHardwareTypeNamesEnum
        :keyword azure_large_instance_size: Specifies the Azure Large Instance SKU. Known values are:
         "S72m", "S144m", "S72", "S144", "S192", "S192m", "S192xm", "S96", "S112", "S224", "S224m",
         "S224om", "S224oo", "S224oom", "S224ooo", "S224se", "S384", "S384m", "S384xm", "S384xxm",
         "S448", "S448m", "S448om", "S448oo", "S448oom", "S448ooo", "S448se", "S576m", "S576xm", "S672",
         "S672m", "S672om", "S672oo", "S672oom", "S672ooo", "S768", "S768m", "S768xm", "S896", "S896m",
         "S896om", "S896oo", "S896oom", "S896ooo", and "S960m".
        :paramtype azure_large_instance_size: str or
         ~azure.mgmt.azurelargeinstance.models.AzureLargeInstanceSizeNamesEnum
        """
        super().__init__(**kwargs)
        self.hardware_type = hardware_type
        self.azure_large_instance_size = azure_large_instance_size
