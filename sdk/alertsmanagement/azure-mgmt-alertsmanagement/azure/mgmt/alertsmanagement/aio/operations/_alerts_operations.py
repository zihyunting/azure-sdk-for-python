...
from ...operations._alerts_operations import (
    ...
    build_list_enrichments_request,
...
class AlertsOperations:
    ...
    ) -> AsyncIterable["_models.AlertEnrichmentResponse"]:
    ...
    @distributed_trace_async
    async def get_enrichments(self, scope: str, alert_id: str, **kwargs: Any) -> _models.AlertEnrichmentResponse:
