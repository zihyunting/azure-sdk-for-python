...
def build_list_request(
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2020-10-31"))
...
class DigitalTwinsEndpointOperations:
    ...
    def list(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._api_version or "2020-10-31"))
