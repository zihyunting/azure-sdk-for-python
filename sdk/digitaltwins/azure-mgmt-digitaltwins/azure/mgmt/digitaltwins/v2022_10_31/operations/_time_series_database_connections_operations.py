...
def build_list_request(
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2022-10-31"))
...
class TimeSeriesDatabaseConnectionsOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either TimeSeriesDatabaseConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.digitaltwins.v2022_10_31.models.TimeSeriesDatabaseConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})

        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._api_version or "2022-10-31"))
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.digitaltwins.v2022_10_31.models.TimeSeriesDatabaseConnection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
