...
class AzureDigitalTwinsManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype digital_twins: azure.mgmt.digitaltwins.v2022_10_31.operations.DigitalTwinsOperations
    :ivar digital_twins_endpoint: DigitalTwinsEndpointOperations operations
    :vartype digital_twins_endpoint:
     azure.mgmt.digitaltwins.v2022_10_31.operations.DigitalTwinsEndpointOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.digitaltwins.v2022_10_31.operations.Operations
    :ivar private_link_resources: PrivateLinkResourcesOperations operations
    :vartype private_link_resources:
     azure.mgmt.digitaltwins.v2022_10_31.operations.PrivateLinkResourcesOperations
    :ivar private_endpoint_connections: PrivateEndpointConnectionsOperations operations
    :vartype private_endpoint_connections:
     azure.mgmt.digitaltwins.v2022_10_31.operations.PrivateEndpointConnectionsOperations
    ...
    :vartype time_series_database_connections:
     azure.mgmt.digitaltwins.v2022_10_31.operations.TimeSeriesDatabaseConnectionsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.digital_twins = DigitalTwinsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2022-10-31"
        )
        self.digital_twins_endpoint = DigitalTwinsEndpointOperations(
            self._client, self._config, self._serialize, self._deserialize, "2022-10-31"
        )
        self.operations = Operations(self._client, self._config, self._serialize, self._deserialize, "2022-10-31")
