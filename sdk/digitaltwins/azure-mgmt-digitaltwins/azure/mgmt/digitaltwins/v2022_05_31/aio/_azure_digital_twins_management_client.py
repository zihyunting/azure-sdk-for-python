    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.digital_twins = DigitalTwinsOperations(
            self._client, self._config, self._serialize, self._deserialize, "2022-05-31"
        )
        self.digital_twins_endpoint = DigitalTwinsEndpointOperations(
            self._client, self._config, self._serialize, self._deserialize, "2022-05-31"
        )
        self.operations = Operations(self._client, self._config, self._serialize, self._deserialize, "2022-05-31")
