...
from ...operations._attestation_providers_operations import (
    ...
    build_get_request,
    build_list_by_provider_request,
...
class AttestationProvidersOperations:
    ...
    def list_by_resource_group(
    ...
    ) -> AsyncIterable["_models.AttestationProvider"]:
        ...
        :return: An iterator like instance of either AttestationProvider or the result of cls(response)
        :rtype:
    ...
    async def create(
        ...
        provider_name: str,
        resource: _models.AttestationProvider,
        *,
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.attestation.models.AttestationProvider
    ...
    async def create(
        ...
        resource_group_name: str,
        provider_name: str,
        resource: Union[_models.AttestationProvider, IO],
        **kwargs: Any
    ) -> _models.AttestationProvider:
        """Creates or updates an Attestation Provider.
        ...
        :param provider_name: Name of the attestation provider. Required.
        :type provider_name: str
        :param resource: Resource create parameters. Is either a AttestationProvider type or a IO type.
         Required.
        :type resource: ~azure.mgmt.attestation.models.AttestationProvider or IO
        ...
        if isinstance(resource, (IOBase, bytes)):
            ...
            _json = self._serialize.body(resource, "AttestationProvider")
    ...
    async def update(
        ...
        resource_group_name: str,
        provider_name: str,
        properties: _models.AttestationProviderUpdate,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.AttestationProvider:
        ...
        :type properties: ~azure.mgmt.attestation.models.AttestationProviderUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def update(
        ...
        resource_group_name: str,
        provider_name: str,
        properties: Union[_models.AttestationProviderUpdate, IO],
        **kwargs: Any
    ) -> _models.AttestationProvider:
        """Updates the Attestation Provider.
        ...
        :param provider_name: Name of the attestation provider. Required.
        :type provider_name: str
        :param properties: The resource properties to be updated. Is either a AttestationProviderUpdate
         type or a IO type. Required.
        :type properties: ~azure.mgmt.attestation.models.AttestationProviderUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "AttestationProviderUpdate")
    ...
    async def list_by_provider(
        self, resource_group_name: str, provider_name: str, subscription_id: str, **kwargs: Any
    ...
    list_by_provider.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Attestation/attestationProviders/{providerName}/privateLinkResources/{resourceGroupName}/{providerName}/{subscriptionId}"
    }
