...
def build_list_for_scope_request(scope: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alertDefinitions"
    )
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
    }
...
class AlertDefinitionsOperations:
    ...
    get.metadata = {
        "url": "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alertDefinitions/{alertDefinitionId}"
    }
    ...
    list_for_scope.metadata = {
        "url": "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alertDefinitions"
    }
