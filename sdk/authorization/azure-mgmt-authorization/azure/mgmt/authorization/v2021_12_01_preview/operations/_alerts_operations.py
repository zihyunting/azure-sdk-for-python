...
def build_get_request(scope: str, alert_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alerts/{alertId}"
    )
...
def build_list_for_scope_request(scope: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alerts")
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
    }
...
def build_refresh_request(scope: str, alert_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alerts/{alertId}/refresh"
...
def build_refresh_all_request(scope: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alerts/refresh")
    path_format_arguments = {
        "scope": _SERIALIZER.url("scope", scope, "str", skip_quote=True),
    }
...
class AlertsOperations:
    ...
    get.metadata = {"url": "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alerts/{alertId}"}
    ...
    @distributed_trace
    def update(self, scope: str, alert_id: str, parameters: Union[_models.Alert, IO], **kwargs: Any) -> _models.Alert:
        """Update an alert.
    ...
    update.metadata = {"url": "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alerts/{alertId}"}
    ...
    list_for_scope.metadata = {"url": "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alerts"}
    ...
    _refresh_initial.metadata = {
        "url": "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alerts/{alertId}/refresh"
    }
    ...
    _refresh_all_initial.metadata = {
        "url": "/{scope}/providers/Microsoft.Authorization/roleManagementAlerts/alerts/refresh"
    }
