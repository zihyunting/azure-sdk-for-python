...
class SecurityCenter(MultiApiClientMixin, _SDKClient):
    ...
    def data_scanners(self):
        """Instance depends on the API version:
           ...
           * 2023-01-01-preview: :class:`DataScannersOperations<azure.mgmt.security.v2023_01_01_preview.operations.DataScannersOperations>`
        """
        api_version = self._get_api_version('data_scanners')
        if api_version == '2023-01-01-preview':
            from .v2023_01_01_preview.operations import DataScannersOperations as OperationClass
        else:
