...
from ...operations._management_group_governance_rules_delete_status_operations import build_get_request
...
class ManagementGroupGovernanceRulesDeleteStatusOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`management_group_governance_rules_delete_status` attribute.
    """
    ...
    async def get(  # pylint: disable=inconsistent-return-statements
        ...
        """Get a specific governance rule deletion status for the requested scope by rule ID and operation
        ID.
    ...
    get.metadata = {
        "url": "/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Security/governanceRules/{ruleId}/delete/operationResults/{operationId}"
    }
