...
from .operations import DataScannersOperations, SecurityOperatorsOperations
...
class SecurityCenter:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype security_operators:
     azure.mgmt.security.v2023_01_01_preview.aio.operations.SecurityOperatorsOperations
    :ivar data_scanners: DataScannersOperations operations
    :vartype data_scanners:
     azure.mgmt.security.v2023_01_01_preview.aio.operations.DataScannersOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.data_scanners = DataScannersOperations(
            self._client, self._config, self._serialize, self._deserialize, "2023-01-01-preview"
        )
