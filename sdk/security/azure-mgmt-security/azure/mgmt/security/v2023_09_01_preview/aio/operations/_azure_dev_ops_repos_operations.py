...
class AzureDevOpsReposOperations:
    ...
    list.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/securityConnectors/{securityConnectorName}/devops/default/azureDevOpsOrgs/{orgName}/projects/{projectName}/repos"
    }
    ...
    get.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Security/securityConnectors/{securityConnectorName}/devops/default/azureDevOpsOrgs/{orgName}/projects/{projectName}/repos/{repoName}"
    }
    ...
    async def _create_or_update_initial(
        ...
        project_name: str,
        repo_name: str,
        azure_dev_ops_repository: Union[_models.AzureDevOpsRepository, IO],
        **kwargs: Any
    ) -> _models.AzureDevOpsRepository:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type repo_name: str
        :param azure_dev_ops_repository: The Azure DevOps repository resource payload. Required.
        :type azure_dev_ops_repository: IO
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param azure_dev_ops_repository: The Azure DevOps repository resource payload. Is either a
         AzureDevOpsRepository type or a IO type. Required.
        :type azure_dev_ops_repository:
         ~azure.mgmt.security.v2023_09_01_preview.models.AzureDevOpsRepository or IO
