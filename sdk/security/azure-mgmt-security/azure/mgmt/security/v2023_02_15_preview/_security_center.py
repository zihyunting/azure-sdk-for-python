...
from .operations import SecurityCenterOperationsMixin, SensitivitySettingsOperations
...
class SecurityCenter(SecurityCenterOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    """API spec for Microsoft.Security (Azure Security Center) resource provider.

    :ivar sensitivity_settings: SensitivitySettingsOperations operations
    :vartype sensitivity_settings:
     azure.mgmt.security.v2023_02_15_preview.operations.SensitivitySettingsOperations
