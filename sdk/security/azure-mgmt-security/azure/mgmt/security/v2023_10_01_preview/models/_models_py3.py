...
class DefenderCspmAwsOfferingMdcContainersAgentlessDiscoveryK8S(_serialization.Model):
...
class DefenderCspmAwsOfferingMdcContainersImageAssessment(_serialization.Model):
...
class DefenderCspmGcpOfferingDataSensitivityDiscovery(_serialization.Model):
    """The Microsoft Defender Data Sensitivity discovery configuration.
...
class DefenderCspmGcpOfferingMdcContainersAgentlessDiscoveryK8S(_serialization.Model):
...
class DefenderCspmGcpOfferingMdcContainersImageAssessment(_serialization.Model):
    """The Microsoft Defender Container image assessment configuration.
...
class DefenderCspmGcpOfferingVmScannersConfiguration(_serialization.Model):
    """configuration for Microsoft Defender for Server VM scanning.
...
class DefenderForContainersAwsOfferingMdcContainersAgentlessDiscoveryK8S(_serialization.Model):
    """The Microsoft Defender container agentless discovery K8s configuration.
...
class DefenderForContainersAwsOfferingMdcContainersImageAssessment(_serialization.Model):
    """The Microsoft Defender container image assessment configuration.
...
class DefenderForContainersGcpOfferingMdcContainersAgentlessDiscoveryK8S(_serialization.Model):
    """The Microsoft Defender Container agentless discovery configuration.
...
class DefenderForContainersGcpOfferingMdcContainersImageAssessment(_serialization.Model):
    """The Microsoft Defender Container image assessment configuration.
