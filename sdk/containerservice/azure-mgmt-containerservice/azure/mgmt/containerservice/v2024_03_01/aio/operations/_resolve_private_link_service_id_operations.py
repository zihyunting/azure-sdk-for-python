...
class ResolvePrivateLinkServiceIdOperations:
    ...
    async def post(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2024_03_01.models.PrivateLinkResource
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: PrivateLinkResource or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2024_03_01.models.PrivateLinkResource
    ...
    async def post(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.containerservice.v2024_03_01.models.PrivateLinkResource or
         IO[bytes]
        :return: PrivateLinkResource or the result of cls(response)
        :rtype: ~azure.mgmt.containerservice.v2024_03_01.models.PrivateLinkResource
        :raises ~azure.core.exceptions.HttpResponseError:
