...
class AutoScaleProfile(_serialization.Model):
    ...
    :ivar sizes: The list of allowed vm sizes. AKS will use the first available one when
     autoscaling. If a VM size is unavailable (e.g. due to quota or regional capacity reasons), AKS
...
class ScaleProfile(_serialization.Model):
    ...
    :vartype autoscale:
     list[~azure.mgmt.containerservice.v2024_01_02_preview.models.AutoScaleProfile]
    """
