...
# USAGE
    python managed_clusters_create_enable_custom_ca_trust.py
...
# x-ms-original-file: specification/containerservice/resource-manager/Microsoft.ContainerService/aks/preview/2024-03-02-preview/examples/ManagedClustersCreate_EnableCustomCATrust.json
