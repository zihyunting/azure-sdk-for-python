...
class CustomizationData(_serialization.Model):
    ...
    :ivar max_body_size: CCF Property for the maximum size of the http request body: 1MB, 5MB,
     10MB.
    :vartype max_body_size: str
    ...
    _attribute_map = {
        ...
        "max_body_size": {"key": "maxBodySize", "type": "str"},
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword max_body_size: CCF Property for the maximum size of the http request body: 1MB, 5MB,
         10MB.
        :paramtype max_body_size: str
...
class LedgerProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar enclave_platform: Enclave Platform on which Ledger Application is deployed, defaults to
     IntelSgx. Known values are: "IntelSgx" and "AmdSevSnp".
    ...
    _validation = {
        "enclave_platform": {"readonly": True},
...
class ManagedCCFProperties(_serialization.Model):
    ...
    :ivar enclave_platform: Enclave Platform on which MCCF Application is deployed, defaults to
     IntelSgx. Known values are: "IntelSgx" and "AmdSevSnp".
    :vartype enclave_platform: str or ~azure.mgmt.confidentialledger.models.EnclavePlatform
    ...
    :ivar customization_data: Additional Managed CCF deployment-time customizations.
    :vartype customization_data: ~azure.mgmt.confidentialledger.models.CustomizationData
    """
    ...
    _attribute_map = {
        ...
        "customization_data": {"key": "customizationData", "type": "CustomizationData"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        running_state: Optional[Union[str, "_models.RunningState"]] = None,
        node_count: int = 3,
        customization_data: Optional["_models.CustomizationData"] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :keyword enclave_platform: Enclave Platform on which MCCF Application is deployed, defaults to
         IntelSgx. Known values are: "IntelSgx" and "AmdSevSnp".
        ...
        :keyword customization_data: Additional Managed CCF deployment-time customizations.
        :paramtype customization_data: ~azure.mgmt.confidentialledger.models.CustomizationData
        """
        super().__init__(**kwargs)
        self.app_name = None
        self.app_uri = None
