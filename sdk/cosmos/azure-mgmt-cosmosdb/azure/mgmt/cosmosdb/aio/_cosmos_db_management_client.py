...
from .operations import NetworkSecurityPerimeterConfigurationsOperations
...
class CosmosDBManagementClient:  # pylint: disable=client-accepts-api-version-keyword
