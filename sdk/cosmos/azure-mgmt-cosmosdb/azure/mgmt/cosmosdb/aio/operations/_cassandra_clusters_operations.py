...
from ...operations._cassandra_clusters_operations import (
    ...
    build_get_async_command_request,
    build_get_backup_request,
    build_get_request,
    build_invoke_async_command_request,
...
class CassandraClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    async def _invoke_async_command_initial(
        self,
        resource_group_name: str,
        cluster_name: str,
        body: Union[_models.CommandPostBody, IO[bytes]],
    ...
    @overload
    async def begin_invoke_async_command(
        self,
        resource_group_name: str,
        cluster_name: str,
        body: _models.CommandPostBody,
    ...
    async def begin_invoke_async_command(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._invoke_async_command_initial(
                resource_group_name=resource_group_name,
                cluster_name=cluster_name,
                body=body,
                api_version=api_version,
