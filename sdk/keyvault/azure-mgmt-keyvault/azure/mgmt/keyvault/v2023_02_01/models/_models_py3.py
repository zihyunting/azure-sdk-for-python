...
class Action(_serialization.Model):
    ...
    :ivar type: The type of the action. Known values are: "Rotate", "rotate", and "Notify".
    ...
    def __init__(
        ...
        """
        :keyword type: The type of the action. Known values are: "Rotate", "rotate", and "Notify".
