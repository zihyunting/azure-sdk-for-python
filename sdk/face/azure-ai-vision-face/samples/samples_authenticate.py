...
class FaceAuthentication():
    ...
    def authentication_by_api_key(self):
        ...
        with FaceAdministrationClient(
            ...
            result = face_admin_client.get_persons()
    ...
    def authentication_by_aad_credential(self):
        ...
        with FaceAdministrationClient(endpoint=self.endpoint, credential=DefaultAzureCredential()) as face_admin_client:
            result = face_admin_client.get_persons()
