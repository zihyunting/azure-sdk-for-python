...
class TestLivenessWithVerifySessionAsync(AzureRecordedTestCase):
    ...
    async def test_create_session_with_verify_image(self, client, **kwargs):
        ...
        # Test `create session` operation
        created_session = await client.create_liveness_with_verify_session_with_verify_image(
            LivenessSessionWithVerifyImageCreationContent(
    ...
    async def test_get_session_result(self, client, **kwargs):
        variables = kwargs.pop("variables", {})
        recorded_session_id = variables.setdefault("sessionId", "f0bc5beb-e61a-476d-b442-7302abd6175c")
