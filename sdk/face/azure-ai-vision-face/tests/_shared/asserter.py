...
def _assert_session_audit_entry_request_info_not_empty(request: models.SessionAuditEntryRequestInfo):
...
def _assert_session_audit_entry_response_info_not_empty(
        response: models.SessionAuditEntryResponseInfo, is_liveness_with_verify: bool = True):
