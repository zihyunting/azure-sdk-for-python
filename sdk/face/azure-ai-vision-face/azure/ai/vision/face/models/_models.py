...
class DetectError(_model_base.Model):
    """The error object.

    You probably want to use the sub-classes and not this class directly. Known sub-classes are:
    DetectErrorBadArgument, DetectErrorInvalidImage, DetectErrorInvalidImageSize,
    DetectErrorInvalidUrl, DetectErrorUnspecified

    All required parameters must be populated in order to send to server.

    :ivar code: One of a server-defined set of error codes. Required. Default value is None.
    :vartype code: str
    ...
    code: str = rest_discriminator(name="code")
    """One of a server-defined set of error codes. Required. Default value is None."""
...
class DetectErrorBadArgument(DetectError, discriminator="BadArgument"):
    """Error response with BadArgument error code. (Status code: 400).

    All required parameters must be populated in order to send to server.

    :ivar code: The BadArgument error code. Required. Default value is "BadArgument".
    :vartype code: str
    :ivar message: The error message of the BadArgument error.


     * JSON parsing error. Bad or unrecognizable request JSON body.
     * Invalid argument returnFaceAttributes. Supported values are: headPose, glasses, occlusion,
     accessories, blur, exposure, noise and mask in a comma-separated format.
     * 'recognitionModel' is invalid.
     * 'detectionModel' is invalid.
     * 'returnFaceAttributes' is not supported by detection_02.
     * 'returnLandmarks' is not supported by detection_02. Required.
    :vartype message: str
    """

    code: Literal["BadArgument"] = rest_discriminator(name="code")  # type: ignore
    """The BadArgument error code. Required. Default value is \"BadArgument\"."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, code="BadArgument", **kwargs)


class DetectErrorInvalidImage(DetectError, discriminator="InvalidImage"):
    """Error response with InvalidImage error code. (Status code: 400).

    All required parameters must be populated in order to send to server.

    :ivar code: The InvalidImage error code. Required. Default value is "InvalidImage".
    :vartype code: str
    :ivar message: The error message of the InvalidImage error.

     .. code-block::

        * Decoding error, image format unsupported. Required.
    :vartype message: str
    """

    code: Literal["InvalidImage"] = rest_discriminator(name="code")  # type: ignore
    """The InvalidImage error code. Required. Default value is \"InvalidImage\"."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, code="InvalidImage", **kwargs)


class DetectErrorInvalidImageSize(DetectError, discriminator="InvalidImageSize"):
    """Error response with InvalidImageSize error code. (Status code: 400).

    All required parameters must be populated in order to send to server.

    :ivar code: The InvalidImageSize error code. Required. Default value is "InvalidImageSize".
    :vartype code: str
    :ivar message: The error message of the InvalidImageSize error.

     ..

        * Image size is too small. The valid image file size should be larger than or equal to 1KB.
        * Image size is too big. The valid image file size should be no larger than 6MB. Required.
    :vartype message: str
    """

    code: Literal["InvalidImageSize"] = rest_discriminator(name="code")  # type: ignore
    """The InvalidImageSize error code. Required. Default value is \"InvalidImageSize\"."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, code="InvalidImageSize", **kwargs)


class DetectErrorInvalidUrl(DetectError, discriminator="InvalidURL"):
    """Error response with InvalidURL error code. (Status code: 400).

    All required parameters must be populated in order to send to server.

    :ivar code: The InvalidURL error code. Required. Default value is "InvalidURL".
    :vartype code: str
    :ivar message: The error message of the InvalidURL error.


     * Invalid image format or URL. Supported formats include JPEG, PNG, GIF(the first frame) and
     BMP.
     * Failed to download image from the specified URL. Remote server error returned. Required.
    :vartype message: str
    """

    code: Literal["InvalidURL"] = rest_discriminator(name="code")  # type: ignore
    """The InvalidURL error code. Required. Default value is \"InvalidURL\"."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, code="InvalidURL", **kwargs)


class DetectErrorResponse(_model_base.Model):
    """A response containing error details.

    All required parameters must be populated in order to send to server.

    :ivar error: The error object. Required.
    :vartype error: ~azure.ai.vision.face.models.DetectError
    """

    error: "_models.DetectError" = rest_field()
...
class DetectErrorUnspecified(DetectError, discriminator="Unspecified"):
    """Error response with Unspecified error code. (Status code: 401).

    All required parameters must be populated in order to send to server.

    :ivar code: The Unspecified error code. Required. Default value is "Unspecified".
    :vartype code: str
    :ivar message: The error message of the Unspecified error.

     ..

        * Invalid subscription Key or user/plan is blocked. Required.
    :vartype message: str
    """

    code: Literal["Unspecified"] = rest_discriminator(name="code")  # type: ignore
    """The Unspecified error code. Required. Default value is \"Unspecified\"."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:  # pylint: disable=useless-super-delegation
        super().__init__(*args, code="Unspecified", **kwargs)
...
class UserDefinedFields(_model_base.Model):
    """Model for object name and user data.
