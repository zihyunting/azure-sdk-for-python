...
class FaceAdministrationClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ...
    @overload
    def _create_dynamic_person_group(  # pylint: disable=inconsistent-return-statements,protected-access
        self,
        dynamic_person_group_id: str,
    ...
    @overload
    def _update_dynamic_person_group(  # pylint: disable=inconsistent-return-statements,protected-access
        self,
        dynamic_person_group_id: str,
