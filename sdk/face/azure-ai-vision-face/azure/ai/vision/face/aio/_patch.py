...
class FaceAdministrationClient(FaceAdministrationClientGenerated):
    ...
    # TODO
    @distributed_trace_async
    async def add_person_face_from_url(
        self,
        person_id: str,
        url: str,
        ...
        * This is a long running operation. Use Response Header "Operation-Location" to determine when
        ...
        """
        # TODO
        return await FaceAdministrationClientOperationsMixin._add_person_face_from_url(
            self,
            person_id,
            recognition_model,
            url=url,
    ...
    async def add_person_face(
        ...
        * This is a long running operation. Use Response Header "Operation-Location" to determine when
        ...
        """
        # TODO
        return await FaceAdministrationClientOperationsMixin._add_person_face(
            self,
            person_id,
            recognition_model,
            image_content,
...
class FaceSessionClient(FaceSessionClientGenerated):
    ...
    # TODO
    @distributed_trace_async
    async def create_liveness_with_verify_session_with_verify_image(  # pylint: disable=protected-access,name-too-long
