    ...
    async def detect_from_url(
        ...
        * Different 'recognitionModel' values are provided. If follow-up operations like Verify,
        ...
        if response.status_code not in [200]:
            ...
            error = _deserialize(_models.DetectErrorResponse, response.json())
...
class FaceAdministrationClientOperationsMixin(  # pylint: disable=too-many-public-methods
    ...
    async def update_face_list(  # pylint: disable=inconsistent-return-statements
        self,
        face_list_id: str,
        body: _models.UserDefinedFields,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> None:
        ...
        :type face_list_id: str
        :param body: Required.
        :type body: ~azure.ai.vision.face.models.UserDefinedFields
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: None
    ...
    @distributed_trace_async
    async def update_face_list(  # pylint: disable=inconsistent-return-statements
        self, face_list_id: str, body: Union[_models.UserDefinedFields, JSON, IO[bytes]], **kwargs: Any
    ) -> None:
        """Update information of a face list, including name and userData.
        ...
        :param face_list_id: Valid character is letter in lower case or digit or '-' or '_', maximum
         length is 64. Required.
        :type face_list_id: str
        :param body: Is one of the following types: UserDefinedFields, JSON, IO[bytes] Required.
        :type body: ~azure.ai.vision.face.models.UserDefinedFields or JSON or IO[bytes]
        :return: None
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
                ...
                response == [
                    {
                        ...
                        "name": "str",  # User defined name, maximum length is 128. Required.
                        "recognitionModel": "str",  # Optional. The 'recognitionModel'
                          associated with this face list. Supported 'recognitionModel' values include
                          'recognition_01', 'recognition_02, 'recognition_03', and 'recognition_04'.
                          The default value is 'recognition_01'. 'recognition_04' is recommended since
                          its accuracy is improved on faces wearing masks compared with
                          'recognition_03', and its overall accuracy is improved compared with
                          'recognition_01' and 'recognition_02'. Known values are: "recognition_01",
    ...
    async def add_face_list_face_from_url(
        ...
        * Different 'detectionModel' values can be provided. To use and compare different detection
        ...
        :type face_list_id: str
        :param body: Required.
        :type body: ~azure.ai.vision.face.models.FaceListFace
    ...
    async def add_face_list_face_from_url(
        self,
        face_list_id: str,
        body: Union[_models.FaceListFace, JSON, IO[bytes]],
        *,
        target_face: Optional[str] = None,
        detection_model: Optional[Union[str, _models.FaceDetectionModel]] = None,
        user_data: Optional[str] = None,
        ...
        * Different 'detectionModel' values can be provided. To use and compare different detection
        ...
        :param face_list_id: Valid character is letter in lower case or digit or '-' or '_', maximum
         length is 64. Required.
        :type face_list_id: str
        :param body: Is one of the following types: FaceListFace, JSON, IO[bytes] Required.
        :type body: ~azure.ai.vision.face.models.FaceListFace or JSON or IO[bytes]
        :keyword target_face: A face rectangle to specify the target face to be added to a person, in
         the format of 'targetFace=left,top,width,height'. Default value is None.
        :paramtype target_face: str
        :keyword detection_model: The 'detectionModel' associated with the detected faceIds. Supported
    ...
    @distributed_trace_async
    async def update_large_face_list(  # pylint: disable=inconsistent-return-statements
        self, large_face_list_id: str, body: Union[_models.UserDefinedFields, JSON, IO[bytes]], **kwargs: Any
    ) -> None:
        """Update information of a large face list, including name and userData.
    ...
    @distributed_trace_async
    async def begin_train_large_face_list(
        self, large_face_list_id: str, **kwargs: Any
    ) -> AsyncLROPoller[_models.FaceCollectionTrainingStatus]:
        # pylint: disable=line-too-long
        ...
        :param large_face_list_id: Valid character is letter in lower case or digit or '-' or '_',
         maximum length is 64. Required.
        :type large_face_list_id: str
        :return: An instance of AsyncLROPoller that returns FaceCollectionTrainingStatus. The
         FaceCollectionTrainingStatus is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.ai.vision.face.models.FaceCollectionTrainingStatus]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return AsyncLROPoller[_models.FaceCollectionTrainingStatus].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.FaceCollectionTrainingStatus](
    ...
    async def add_large_face_list_face_from_url(
        self,
        large_face_list_id: str,
        body: _models.LargeFaceListFace,
        *,
        target_face: Optional[str] = None,
        detection_model: Optional[Union[str, _models.FaceDetectionModel]] = None,
        user_data: Optional[str] = None,
        ...
        * Different 'detectionModel' values can be provided. To use and compare different detection
        ...
        :type large_face_list_id: str
        :param body: Required.
        :type body: ~azure.ai.vision.face.models.LargeFaceListFace
        :keyword target_face: A face rectangle to specify the target face to be added to a person, in
         the format of 'targetFace=left,top,width,height'. Default value is None.
        :paramtype target_face: str
        :keyword detection_model: The 'detectionModel' associated with the detected faceIds. Supported
    ...
    async def add_large_face_list_face_from_url(
        self,
        large_face_list_id: str,
        body: Union[_models.LargeFaceListFace, JSON, IO[bytes]],
        *,
        target_face: Optional[str] = None,
        detection_model: Optional[Union[str, _models.FaceDetectionModel]] = None,
        user_data: Optional[str] = None,
        ...
        * Different 'detectionModel' values can be provided. To use and compare different detection
        ...
        :param large_face_list_id: Valid character is letter in lower case or digit or '-' or '_',
         maximum length is 64. Required.
        :type large_face_list_id: str
        :param body: Is one of the following types: LargeFaceListFace, JSON, IO[bytes] Required.
        :type body: ~azure.ai.vision.face.models.LargeFaceListFace or JSON or IO[bytes]
        :keyword target_face: A face rectangle to specify the target face to be added to a person, in
         the format of 'targetFace=left,top,width,height'. Default value is None.
        :paramtype target_face: str
        :keyword detection_model: The 'detectionModel' associated with the detected faceIds. Supported
    ...
    @distributed_trace_async
    async def update_person_group(  # pylint: disable=inconsistent-return-statements
        self, person_group_id: str, body: Union[_models.UserDefinedFields, JSON, IO[bytes]], **kwargs: Any
    ) -> None:
        """Update an existing person group's name and userData. The properties keep unchanged if they are
        not in request body.
    ...
    async def get_person_groups(
        ...
        * Person groups are stored in alphabetical order of personGroupId.
          ...
          * "start" parameter (string, optional) is a id value that returned entries have larger ids by
        string comparison. "start" set to empty to indicate return from the first item.
          * "top" parameter (int, optional) specifies the number of entries to return. A maximal of
        1000 entries can be returned in one call. To fetch more, you can specify "start" with the last
        returned entry's personId of the current call.
    ...
    @distributed_trace_async
    async def begin_train_person_group(
        self, person_group_id: str, **kwargs: Any
    ) -> AsyncLROPoller[_models.FaceCollectionTrainingStatus]:
        # pylint: disable=line-too-long
    ...
    async def update_person_group_person(  # pylint: disable=inconsistent-return-statements
        ...
        person_group_id: str,
        person_id: str,
        body: Union[_models.UserDefinedFields, JSON, IO[bytes]],
        **kwargs: Any
    ) -> None:
        """Update name or userData of a person.
    ...
    async def add_person_group_person_face_from_url(
        ...
        person_group_id: str,
        person_id: str,
        body: _models.PersonGroupPersonFace,
        *,
        target_face: Optional[str] = None,
        detection_model: Optional[Union[str, _models.FaceDetectionModel]] = None,
        user_data: Optional[str] = None,
        ...
        * Different 'detectionModel' values can be provided. To use and compare different detection
        ...
        :type person_id: str
        :param body: Required.
        :type body: ~azure.ai.vision.face.models.PersonGroupPersonFace
        :keyword target_face: A face rectangle to specify the target face to be added to a person, in
         the format of 'targetFace=left,top,width,height'. Default value is None.
        :paramtype target_face: str
        :keyword detection_model: The 'detectionModel' associated with the detected faceIds. Supported
    ...
    async def add_person_group_person_face_from_url(
        ...
        person_group_id: str,
        person_id: str,
        body: Union[_models.PersonGroupPersonFace, JSON, IO[bytes]],
        *,
        target_face: Optional[str] = None,
        detection_model: Optional[Union[str, _models.FaceDetectionModel]] = None,
        user_data: Optional[str] = None,
        ...
        * Different 'detectionModel' values can be provided. To use and compare different detection
        ...
        :param person_id: ID of the person. Required.
        :type person_id: str
        :param body: Is one of the following types: PersonGroupPersonFace, JSON, IO[bytes] Required.
        :type body: ~azure.ai.vision.face.models.PersonGroupPersonFace or JSON or IO[bytes]
        :keyword target_face: A face rectangle to specify the target face to be added to a person, in
         the format of 'targetFace=left,top,width,height'. Default value is None.
        :paramtype target_face: str
        :keyword detection_model: The 'detectionModel' associated with the detected faceIds. Supported
    ...
    @distributed_trace_async
    async def update_large_person_group(  # pylint: disable=inconsistent-return-statements
        self, large_person_group_id: str, body: Union[_models.UserDefinedFields, JSON, IO[bytes]], **kwargs: Any
    ) -> None:
        """Update an existing large person group's name and userData. The properties keep unchanged if
        they are not in request body.
    ...
    @distributed_trace_async
    async def begin_train_large_person_group(
        self, large_person_group_id: str, **kwargs: Any
    ) -> AsyncLROPoller[_models.FaceCollectionTrainingStatus]:
        # pylint: disable=line-too-long
    ...
    async def add_large_person_group_person_face_from_url(  # pylint: disable=name-too-long
        ...
        large_person_group_id: str,
        person_id: str,
        body: _models.LargePersonGroupPersonFace,
        *,
        target_face: Optional[str] = None,
        detection_model: Optional[Union[str, _models.FaceDetectionModel]] = None,
        user_data: Optional[str] = None,
        ...
        * Different 'detectionModel' values can be provided. To use and compare different detection
        ...
        :type person_id: str
        :param body: Required.
        :type body: ~azure.ai.vision.face.models.LargePersonGroupPersonFace
        :keyword target_face: A face rectangle to specify the target face to be added to a person, in
         the format of 'targetFace=left,top,width,height'. Default value is None.
        :paramtype target_face: str
        :keyword detection_model: The 'detectionModel' associated with the detected faceIds. Supported
    ...
    async def add_large_person_group_person_face_from_url(  # pylint: disable=name-too-long
        ...
        large_person_group_id: str,
        person_id: str,
        body: Union[_models.LargePersonGroupPersonFace, JSON, IO[bytes]],
        *,
        target_face: Optional[str] = None,
        detection_model: Optional[Union[str, _models.FaceDetectionModel]] = None,
        user_data: Optional[str] = None,
        ...
        * Different 'detectionModel' values can be provided. To use and compare different detection
        ...
        :param person_id: ID of the person. Required.
        :type person_id: str
        :param body: Is one of the following types: LargePersonGroupPersonFace, JSON, IO[bytes]
         Required.
        :type body: ~azure.ai.vision.face.models.LargePersonGroupPersonFace or JSON or IO[bytes]
        :keyword target_face: A face rectangle to specify the target face to be added to a person, in
         the format of 'targetFace=left,top,width,height'. Default value is None.
        :paramtype target_face: str
        :keyword detection_model: The 'detectionModel' associated with the detected faceIds. Supported
    ...
    @distributed_trace_async
    async def begin_delete_person(self, person_id: str, **kwargs: Any) -> AsyncLROPoller[_models.FaceOperationStatus]:
        # pylint: disable=line-too-long
        ...
        :type person_id: str
        :return: An instance of AsyncLROPoller that returns FaceOperationStatus. The
         FaceOperationStatus is compatible with MutableMapping
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.ai.vision.face.models.FaceOperationStatus]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return AsyncLROPoller[_models.FaceOperationStatus].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.FaceOperationStatus](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    async def update_person(  # pylint: disable=inconsistent-return-statements
        self, person_id: str, body: _models.UserDefinedFields, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        """Update name or userData of a person.
    ...
    @distributed_trace_async
    async def update_person(  # pylint: disable=inconsistent-return-statements
        self, person_id: str, body: Union[_models.UserDefinedFields, JSON, IO[bytes]], **kwargs: Any
    ) -> None:
        """Update name or userData of a person.
    ...
    @overload
    async def _add_person_face_from_url(
        self,
        person_id: str,
        recognition_model: Union[str, _models.FaceRecognitionModel],
        body: _models.PersonDirectoryFace,
        *,
        target_face: Optional[str] = None,
        detection_model: Optional[Union[str, _models.FaceDetectionModel]] = None,
        user_data: Optional[str] = None,
    ...
    async def _add_person_face_from_url(
        ...
        person_id: str,
        recognition_model: Union[str, _models.FaceRecognitionModel],
        body: Union[_models.PersonDirectoryFace, JSON, IO[bytes]],
        *,
        target_face: Optional[str] = None,
        detection_model: Optional[Union[str, _models.FaceDetectionModel]] = None,
        user_data: Optional[str] = None,
        ...
        * This is a long running operation. Use Response Header "Operation-Location" to determine when
        ...
        :param body: Is one of the following types: PersonDirectoryFace, JSON, IO[bytes] Required.
        :type body: ~azure.ai.vision.face.models.PersonDirectoryFace or JSON or IO[bytes]
        :keyword target_face: A face rectangle to specify the target face to be added to a person, in
         the format of 'targetFace=left,top,width,height'. Default value is None.
        :paramtype target_face: str
        :keyword detection_model: The 'detectionModel' associated with the detected faceIds. Supported
    ...
    async def begin_delete_person_face(
        ...
        persisted_face_id: str,
        **kwargs: Any
    ) -> AsyncLROPoller[_models.FaceOperationStatus]:
        # pylint: disable=line-too-long
    ...
    @overload
    async def _create_dynamic_person_group(  # pylint: disable=inconsistent-return-statements,protected-access
        self,
        dynamic_person_group_id: str,
        resource: _models._models.CreateDynamicPersonGroupContent,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> None:
    ...
    @overload
    async def _create_dynamic_person_group(  # pylint: disable=inconsistent-return-statements
    ...
    async def _create_dynamic_person_group(  # pylint: disable=inconsistent-return-statements
        self,
        dynamic_person_group_id: str,
        resource: Union[_models._models.CreateDynamicPersonGroupContent, JSON, IO[bytes]],
        **kwargs: Any
    ) -> None:
    ...
    @overload
    async def _update_dynamic_person_group(  # pylint: disable=inconsistent-return-statements,protected-access
        self,
        dynamic_person_group_id: str,
        resource: _models._models.UpdateDynamicPersonGroupContent,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> None:
    ...
    @overload
    async def _update_dynamic_person_group(  # pylint: disable=inconsistent-return-statements
        self, dynamic_person_group_id: str, resource: JSON, *, content_type: str = "application/json", **kwargs: Any
    ) -> None:
        ...
    ...
    async def _update_dynamic_person_group(  # pylint: disable=inconsistent-return-statements
        self,
        dynamic_person_group_id: str,
        resource: Union[_models._models.UpdateDynamicPersonGroupContent, JSON, IO[bytes]],
        **kwargs: Any
    ) -> None:
...
class FaceSessionClientOperationsMixin(FaceSessionClientMixinABC):
    ...
    @overload
    async def create_liveness_with_verify_session_with_verify_image(  # pylint: disable=name-too-long
