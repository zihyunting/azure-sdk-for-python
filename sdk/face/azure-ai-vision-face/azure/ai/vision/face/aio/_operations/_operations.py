...
class FaceClientOperationsMixin(FaceClientMixinABC):
    ...
    async def _detect_from_url(
        ...
        * Different 'recognitionModel' values are provided. If follow-up operations like Verify,
        ...
        cls: ClsType[List[_models._models.FaceDetectionResult]] = kwargs.pop(  # pylint: disable=protected-access
            "cls", None
        )
        ...
        if _stream:
            ...
            deserialized = _deserialize(List[_models._models.FaceDetectionResult], response.json())
