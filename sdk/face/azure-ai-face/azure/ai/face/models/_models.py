...
class AccessoryItem(_model_base.Model):
    ...
    :ivar type: Type of the accessory. Required. Known values are: "headwear", "glasses", and
     "mask".
    :vartype type: str or ~azure.ai.face.models.AccessoryType
...
class AsyncOperationStatus(_model_base.Model):
    ...
    :vartype status: str or ~azure.ai.face.models.OperationStatus
...
class BlurProperties(_model_base.Model):
    ...
    :ivar blur_level: An enum value indicating level of blurriness. Required. Known values are:
     "low", "medium", and "high".
    :vartype blur_level: str or ~azure.ai.face.models.BlurLevel
...
class DynamicPersonGroup(_model_base.Model):
    ...
    add_person_ids: Optional[List[str]] = rest_field(name="addPersonIds", visibility=["create"])
...
class ExposureProperties(_model_base.Model):
    ...
    :vartype exposure_level: str or ~azure.ai.face.models.ExposureLevel
...
class FaceAttributes(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype quality_for_recognition: str or ~azure.ai.face.models.QualityForRecognition
    """
...
class FaceDetectionResult(_model_base.Model):
    ...
    :vartype face_rectangle: ~azure.ai.face.models.FaceRectangle
    ...
    :vartype face_landmarks: ~azure.ai.face.models.FaceLandmarks
    :ivar face_attributes: Face attributes fore detected face.
    :vartype face_attributes: ~azure.ai.face.models.FaceAttributes
    """
...
class FaceLandmarks(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype pupil_left: ~azure.ai.face.models.LandmarkCoordinate
    :ivar pupil_right: Coordinates within an image. Required.
    :vartype pupil_right: ~azure.ai.face.models.LandmarkCoordinate
    :ivar nose_tip: Coordinates within an image. Required.
    :vartype nose_tip: ~azure.ai.face.models.LandmarkCoordinate
    :ivar mouth_left: Coordinates within an image. Required.
    :vartype mouth_left: ~azure.ai.face.models.LandmarkCoordinate
    :ivar mouth_right: Coordinates within an image. Required.
    :vartype mouth_right: ~azure.ai.face.models.LandmarkCoordinate
    :ivar eyebrow_left_outer: Coordinates within an image. Required.
    :vartype eyebrow_left_outer: ~azure.ai.face.models.LandmarkCoordinate
    :ivar eyebrow_left_inner: Coordinates within an image. Required.
    :vartype eyebrow_left_inner: ~azure.ai.face.models.LandmarkCoordinate
    :ivar eye_left_outer: Coordinates within an image. Required.
    :vartype eye_left_outer: ~azure.ai.face.models.LandmarkCoordinate
    :ivar eye_left_top: Coordinates within an image. Required.
    :vartype eye_left_top: ~azure.ai.face.models.LandmarkCoordinate
    :ivar eye_left_bottom: Coordinates within an image. Required.
    :vartype eye_left_bottom: ~azure.ai.face.models.LandmarkCoordinate
    :ivar eye_left_inner: Coordinates within an image. Required.
    :vartype eye_left_inner: ~azure.ai.face.models.LandmarkCoordinate
    :ivar eyebrow_right_inner: Coordinates within an image. Required.
    :vartype eyebrow_right_inner: ~azure.ai.face.models.LandmarkCoordinate
    :ivar eyebrow_right_outer: Coordinates within an image. Required.
    :vartype eyebrow_right_outer: ~azure.ai.face.models.LandmarkCoordinate
    :ivar eye_right_inner: Coordinates within an image. Required.
    :vartype eye_right_inner: ~azure.ai.face.models.LandmarkCoordinate
    :ivar eye_right_top: Coordinates within an image. Required.
    :vartype eye_right_top: ~azure.ai.face.models.LandmarkCoordinate
    :ivar eye_right_bottom: Coordinates within an image. Required.
    :vartype eye_right_bottom: ~azure.ai.face.models.LandmarkCoordinate
    :ivar eye_right_outer: Coordinates within an image. Required.
    :vartype eye_right_outer: ~azure.ai.face.models.LandmarkCoordinate
    :ivar nose_root_left: Coordinates within an image. Required.
    :vartype nose_root_left: ~azure.ai.face.models.LandmarkCoordinate
    :ivar nose_root_right: Coordinates within an image. Required.
    :vartype nose_root_right: ~azure.ai.face.models.LandmarkCoordinate
    :ivar nose_left_alar_top: Coordinates within an image. Required.
    :vartype nose_left_alar_top: ~azure.ai.face.models.LandmarkCoordinate
    :ivar nose_right_alar_top: Coordinates within an image. Required.
    :vartype nose_right_alar_top: ~azure.ai.face.models.LandmarkCoordinate
    :ivar nose_left_alar_out_tip: Coordinates within an image. Required.
    :vartype nose_left_alar_out_tip: ~azure.ai.face.models.LandmarkCoordinate
    :ivar nose_right_alar_out_tip: Coordinates within an image. Required.
    :vartype nose_right_alar_out_tip: ~azure.ai.face.models.LandmarkCoordinate
    :ivar upper_lip_top: Coordinates within an image. Required.
    :vartype upper_lip_top: ~azure.ai.face.models.LandmarkCoordinate
    :ivar upper_lip_bottom: Coordinates within an image. Required.
    :vartype upper_lip_bottom: ~azure.ai.face.models.LandmarkCoordinate
    :ivar under_lip_top: Coordinates within an image. Required.
    :vartype under_lip_top: ~azure.ai.face.models.LandmarkCoordinate
    :ivar under_lip_bottom: Coordinates within an image. Required.
    :vartype under_lip_bottom: ~azure.ai.face.models.LandmarkCoordinate
    """
...
class FaceList(_model_base.Model):
    ...
    :vartype recognition_model: str or ~azure.ai.face.models.RecognitionModel
    ...
    :vartype persisted_faces: list[~azure.ai.face.models.FaceListFace]
    """
...
class FindSimilarResult(_model_base.Model):
...
class GroupResult(_model_base.Model):
...
class HairColor(_model_base.Model):
    ...
    :vartype color: str or ~azure.ai.face.models.HairColorType
...
class HairProperties(_model_base.Model):
    ...
    :ivar hair_color: An array of candidate colors and confidence level in the presence of each.
     Required.
    :vartype hair_color: list[~azure.ai.face.models.HairColor]
    """
...
class IdentifyCandidate(_model_base.Model):
...
class IdentifyResult(_model_base.Model):
    """Identify result.
    ...
    :vartype candidates: list[~azure.ai.face.models.IdentifyCandidate]
    """

    face_id: str = rest_field(name="faceId")
    """Face ID of the query face. Required."""
    candidates: List["_models.IdentifyCandidate"] = rest_field()
    ...
    def __init__(
        ...
        *,
        face_id: str,
        candidates: List["_models.IdentifyCandidate"],
    ):
        ...
...
class LivenessSession(_model_base.Model):
    ...
    :ivar status: The session status. Required. Known values are: "NotStarted", "Started", and
     "ResultAvailable".
    :vartype status: str or ~azure.ai.face.models.SessionStatus
    :ivar result: The last result of session.
    :vartype result: ~azure.ai.face.models.LivenessSessionAuditEntry
    """
...
class LivenessSessionAuditEntry(_model_base.Model):
    ...
    :vartype request: ~azure.ai.face.models.SessionAuditEntryRequestInfo
    :ivar response: The response of this entry. Required.
    :vartype response: ~azure.ai.face.models.SessionAuditEntryResponseInfo
...
class LivenessSessionWithVerifyImageCreationContent(_model_base.Model):  # pylint: disable=name-too-long
    ...
    :ivar creation_content: The CreationContent for creating session. Required.
    :vartype creation_content: ~azure.ai.face.models.LivenessSessionCreationContentForMultipart
    :ivar verify_image: The image stream for verify. Required.
    :vartype verify_image: bytes
    """

    creation_content: "_models.LivenessSessionCreationContentForMultipart" = rest_field(name="CreationContent")
    """The CreationContent for creating session. Required."""
    ...
    def __init__(
        self,
        *,
        creation_content: "_models.LivenessSessionCreationContentForMultipart",
...
class LivenessWithVerifySession(_model_base.Model):
    ...
    :vartype status: str or ~azure.ai.face.models.SessionStatus
    :ivar result: The last result of session.
    :vartype result: ~azure.ai.face.models.LivenessWithVerifySessionAuditEntry
    """
    ...
    """The session status. Required. Known values are: \"NotStarted\", \"Started\", and
     \"ResultAvailable\"."""
    result: Optional["_models.LivenessWithVerifySessionAuditEntry"] = rest_field(visibility=["read"])
    """The last result of session."""
...
class LivenessWithVerifySessionAuditEntry(_model_base.Model):
    """Audit entry for a request in session.
...
class MaskProperties(_model_base.Model):
    ...
    :vartype type: str or ~azure.ai.face.models.MaskType
    """
...
class NoiseProperties(_model_base.Model):
    ...
    :ivar noise_level: An enum value indicating level of noise. Required. Known values are: "low",
     "medium", and "high".
    :vartype noise_level: str or ~azure.ai.face.models.NoiseLevel
...
class TrainingStatus(_model_base.Model):
    ...
    :ivar status: Training status of the container. Required. Known values are: "nonstarted",
     "running", "succeeded", and "failed".
    :vartype status: str or ~azure.ai.face.models.TrainingStatusType
    ...
    status: Union[str, "_models.TrainingStatusType"] = rest_field()
    """Training status of the container. Required. Known values are: \"nonstarted\", \"running\",
     \"succeeded\", and \"failed\"."""
    created_date_time: datetime.datetime = rest_field(name="createdDateTime", format="rfc3339")
    ...
    def __init__(
        self,
        *,
        status: Union[str, "_models.TrainingStatusType"],
        created_date_time: datetime.datetime,
...
class VerifyResult(_model_base.Model):
    """Verify result.
