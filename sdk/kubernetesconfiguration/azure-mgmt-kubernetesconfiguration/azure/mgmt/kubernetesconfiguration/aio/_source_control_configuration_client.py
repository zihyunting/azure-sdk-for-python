...
class SourceControlConfigurationClient(MultiApiClientMixin, _SDKClient):
    ...
    def extensions(self):
        """Instance depends on the API version:
           ...
           * 2024-04-01: :class:`ExtensionsOperations<azure.mgmt.kubernetesconfiguration.v2024_04_01.aio.operations.ExtensionsOperations>`
        """
        ...
        if api_version == '2020-07-01-preview':
            ...
            from ..v2024_04_01.aio.operations import ExtensionsOperations as OperationClass
        else:
    ...
    def flux_config_operation_status(self):
        """Instance depends on the API version:
           ...
           * 2024-04-01: :class:`FluxConfigOperationStatusOperations<azure.mgmt.kubernetesconfiguration.v2024_04_01.aio.operations.FluxConfigOperationStatusOperations>`
        """
        ...
        if api_version == '2021-11-01-preview':
            ...
            from ..v2024_04_01.aio.operations import FluxConfigOperationStatusOperations as OperationClass
        else:
    ...
    def flux_configurations(self):
        """Instance depends on the API version:
           ...
           * 2024-04-01: :class:`FluxConfigurationsOperations<azure.mgmt.kubernetesconfiguration.v2024_04_01.aio.operations.FluxConfigurationsOperations>`
        """
        ...
        if api_version == '2021-11-01-preview':
            ...
            from ..v2024_04_01.aio.operations import FluxConfigurationsOperations as OperationClass
        else:
    ...
    def operation_status(self):
        """Instance depends on the API version:
           ...
           * 2024-04-01: :class:`OperationStatusOperations<azure.mgmt.kubernetesconfiguration.v2024_04_01.aio.operations.OperationStatusOperations>`
        """
        ...
        if api_version == '2021-05-01-preview':
            ...
            from ..v2024_04_01.aio.operations import OperationStatusOperations as OperationClass
        else:
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2024-04-01: :class:`Operations<azure.mgmt.kubernetesconfiguration.v2024_04_01.aio.operations.Operations>`
        """
    ...
    def source_control_configurations(self):
        """Instance depends on the API version:
           ...
           * 2024-04-01: :class:`SourceControlConfigurationsOperations<azure.mgmt.kubernetesconfiguration.v2024_04_01.aio.operations.SourceControlConfigurationsOperations>`
        """
        ...
        if api_version == '2020-07-01-preview':
            ...
            from ..v2024_04_01.aio.operations import SourceControlConfigurationsOperations as OperationClass
        else:
