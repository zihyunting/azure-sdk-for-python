...
class BotsOperations:
    ...
    def create(
        ...
        :param resource_name: The name of the Bot resource. Required.
        :type resource_name: str
        :param parameters: The parameters to provide for the created bot. Is either a Bot type or a IO
         type. Required.
    ...
    def get_check_name_availability(
        ...
        :param parameters: The request body parameters to provide for the check name availability
         request. Is either a CheckNameAvailabilityRequestBody type or a IO type. Required.
