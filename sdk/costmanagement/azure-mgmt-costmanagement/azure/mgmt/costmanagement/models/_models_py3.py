...
class ExportDeliveryDestination(_serialization.Model):
    ...
    :ivar root_folder_path: The name of the directory where exports will be uploaded. Use a period
     (.) to target the root of directory. Required.
    ...
    _validation = {
        ...
        "root_folder_path": {"required": True},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword root_folder_path: The name of the directory where exports will be uploaded. Use a
         period (.) to target the root of directory. Required.
