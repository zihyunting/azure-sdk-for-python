...
class DeploymentStack(AzureResourceBase):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype action_on_unmanage:
     ~azure.mgmt.resource.deploymentstacks.v2024_03_01.models.DeploymentStackPropertiesActionOnUnmanage
    ...
    :ivar bypass_stack_out_of_sync_error: Allows the user to bypass service errors that indicate
     the stack resource list is not correctly synchronized.
    ...
    :ivar correlation_id: The correlation id of the last stack upsert or delete operation. It is in
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :paramtype debug_setting:
         ~azure.mgmt.resource.deploymentstacks.v2024_03_01.models.DeploymentStacksDebugSetting
        :keyword bypass_stack_out_of_sync_error: Allows the user to bypass service errors that indicate
         the stack resource list is not correctly synchronized.
...
class DeploymentStackProperties(ErrorResponse):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype parameters_link:
     ~azure.mgmt.resource.deploymentstacks.v2024_03_01.models.DeploymentStacksParametersLink
    :ivar action_on_unmanage: Defines the behavior of resources that are no longer managed after
     the stack is updated or deleted. Required.
    :vartype action_on_unmanage:
     ~azure.mgmt.resource.deploymentstacks.v2024_03_01.models.DeploymentStackPropertiesActionOnUnmanage
    :ivar debug_setting: The debug setting of the deployment.
    :vartype debug_setting:
