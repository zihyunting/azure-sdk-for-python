...
def build_deployment_stacks_preflight_validate_stack_at_resource_group_request(  # pylint: disable=name-too-long
    resource_group_name: str, deployment_stack_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_deployment_stacks_preflight_validate_stack_at_subscription_request(  # pylint: disable=name-too-long
    deployment_stack_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_deployment_stacks_preflight_validate_stack_at_management_group_request(  # pylint: disable=name-too-long
    management_group_id: str, deployment_stack_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DeploymentStacksOperations:  # pylint: disable=too-many-public-methods
    ...
    def _preflight_validate_stack_at_resource_group_initial(  # pylint: disable=inconsistent-return-statements,name-too-long
        self,
        resource_group_name: str,
        deployment_stack_name: str,
        deployment_stack: Union[_models.DeploymentStack, IO[bytes]],
        **kwargs: Any
        ...
        _request = build_deployment_stacks_preflight_validate_stack_at_resource_group_request(
            resource_group_name=resource_group_name,
            deployment_stack_name=deployment_stack_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    @overload
    def begin_preflight_validate_stack_at_resource_group(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        deployment_stack_name: str,
        deployment_stack: _models.DeploymentStack,
    ...
    def begin_preflight_validate_stack_at_resource_group(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._preflight_validate_stack_at_resource_group_initial(  # type: ignore
                resource_group_name=resource_group_name,
                deployment_stack_name=deployment_stack_name,
                deployment_stack=deployment_stack,
                api_version=api_version,
    ...
    def _preflight_validate_stack_at_subscription_initial(  # pylint: disable=inconsistent-return-statements,name-too-long
        self, deployment_stack_name: str, deployment_stack: Union[_models.DeploymentStack, IO[bytes]], **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
        ...
        _request = build_deployment_stacks_preflight_validate_stack_at_subscription_request(
            deployment_stack_name=deployment_stack_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            content_type=content_type,
    ...
    @overload
    def begin_preflight_validate_stack_at_subscription(  # pylint: disable=name-too-long
        self,
        deployment_stack_name: str,
        deployment_stack: _models.DeploymentStack,
        *,
    ...
    def begin_preflight_validate_stack_at_subscription(  # pylint: disable=name-too-long
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._preflight_validate_stack_at_subscription_initial(  # type: ignore
                deployment_stack_name=deployment_stack_name,
                deployment_stack=deployment_stack,
                api_version=api_version,
                content_type=content_type,
    ...
    def _preflight_validate_stack_at_management_group_initial(  # pylint: disable=inconsistent-return-statements,name-too-long
        self,
        management_group_id: str,
        deployment_stack_name: str,
        deployment_stack: Union[_models.DeploymentStack, IO[bytes]],
        **kwargs: Any
        ...
        _request = build_deployment_stacks_preflight_validate_stack_at_management_group_request(
            management_group_id=management_group_id,
            deployment_stack_name=deployment_stack_name,
            api_version=api_version,
            content_type=content_type,
    ...
    @overload
    def begin_preflight_validate_stack_at_management_group(  # pylint: disable=name-too-long
        self,
        management_group_id: str,
        deployment_stack_name: str,
        deployment_stack: _models.DeploymentStack,
    ...
    def begin_preflight_validate_stack_at_management_group(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._preflight_validate_stack_at_management_group_initial(  # type: ignore
                management_group_id=management_group_id,
                deployment_stack_name=deployment_stack_name,
                deployment_stack=deployment_stack,
                api_version=api_version,
