...
from ...operations._operations import (
    ...
    build_deployment_stacks_preflight_validate_stack_at_management_group_request,
    build_deployment_stacks_preflight_validate_stack_at_resource_group_request,
    build_deployment_stacks_preflight_validate_stack_at_subscription_request,
)
...
class DeploymentStacksOperations:  # pylint: disable=too-many-public-methods
    ...
    async def _preflight_validate_stack_at_resource_group_initial(  # pylint: disable=inconsistent-return-statements,name-too-long
        self,
        resource_group_name: str,
        deployment_stack_name: str,
        deployment_stack: Union[_models.DeploymentStack, IO[bytes]],
    ...
    @overload
    async def begin_preflight_validate_stack_at_resource_group(  # pylint: disable=name-too-long
        self,
        resource_group_name: str,
        deployment_stack_name: str,
        deployment_stack: _models.DeploymentStack,
    ...
    async def begin_preflight_validate_stack_at_resource_group(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._preflight_validate_stack_at_resource_group_initial(  # type: ignore
                resource_group_name=resource_group_name,
                deployment_stack_name=deployment_stack_name,
                deployment_stack=deployment_stack,
                api_version=api_version,
    ...
    async def _preflight_validate_stack_at_subscription_initial(  # pylint: disable=inconsistent-return-statements,name-too-long
        self, deployment_stack_name: str, deployment_stack: Union[_models.DeploymentStack, IO[bytes]], **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
    ...
    @overload
    async def begin_preflight_validate_stack_at_subscription(  # pylint: disable=name-too-long
        self,
        deployment_stack_name: str,
        deployment_stack: _models.DeploymentStack,
        *,
    ...
    async def begin_preflight_validate_stack_at_subscription(  # pylint: disable=name-too-long
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._preflight_validate_stack_at_subscription_initial(  # type: ignore
                deployment_stack_name=deployment_stack_name,
                deployment_stack=deployment_stack,
                api_version=api_version,
                content_type=content_type,
    ...
    async def _preflight_validate_stack_at_management_group_initial(  # pylint: disable=inconsistent-return-statements,name-too-long
        self,
        management_group_id: str,
        deployment_stack_name: str,
        deployment_stack: Union[_models.DeploymentStack, IO[bytes]],
    ...
    @overload
    async def begin_preflight_validate_stack_at_management_group(  # pylint: disable=name-too-long
        self,
        management_group_id: str,
        deployment_stack_name: str,
        deployment_stack: _models.DeploymentStack,
    ...
    async def begin_preflight_validate_stack_at_management_group(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = await self._preflight_validate_stack_at_management_group_initial(  # type: ignore
                management_group_id=management_group_id,
                deployment_stack_name=deployment_stack_name,
                deployment_stack=deployment_stack,
                api_version=api_version,
