...
class DeploymentStacksClient(MultiApiClientMixin, _SDKClient):
    ...
    @property
    def deployment_stacks(self):
        """Instance depends on the API version:

           * 2022-08-01-preview: :class:`DeploymentStacksOperations<azure.mgmt.resource.deploymentstacks.v2022_08_01_preview.aio.operations.DeploymentStacksOperations>`
        """
        api_version = self._get_api_version('deployment_stacks')
        if api_version == '2022-08-01-preview':
            from ..v2022_08_01_preview.aio.operations import DeploymentStacksOperations as OperationClass
        else:
