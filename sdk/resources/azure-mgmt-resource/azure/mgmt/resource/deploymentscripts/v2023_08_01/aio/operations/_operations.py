...
class DeploymentScriptsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.resource.deploymentscripts.v2023_08_01.aio.DeploymentScriptsClient`'s
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either DeploymentScript or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.resource.deploymentscripts.v2023_08_01.models.DeploymentScript]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type deployment_script:
         ~azure.mgmt.resource.deploymentscripts.v2023_08_01.models.DeploymentScript or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type deployment_script:
         ~azure.mgmt.resource.deploymentscripts.v2023_08_01.models.DeploymentScriptUpdateParameter or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.DeploymentScript"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.resource.deploymentscripts.v2023_08_01.models.DeploymentScript]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
