...
class SessionHostConfigurationsOperations:
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        if response.status_code == 200:
            ...
            deserialized = self._deserialize("SessionHostConfiguration", pipeline_response)
    ...
    def _update_initial(
        ...
        **kwargs: Any
    ) -> Optional[_models.SessionHostConfiguration]:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[Optional[_models.SessionHostConfiguration]] = kwargs.pop("cls", None)
