...
from ._configuration import NetworkAnalyticsClientConfiguration
...
class NetworkAnalyticsClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = NetworkAnalyticsClientConfiguration(
    ...
    async def __aenter__(self) -> "NetworkAnalyticsClient":
