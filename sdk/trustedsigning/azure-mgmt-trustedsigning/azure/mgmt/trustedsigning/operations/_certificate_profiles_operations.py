...
def build_list_by_code_signing_account_request(  # pylint: disable=name-too-long
...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "profileName": _SERIALIZER.url(
            "profile_name", profile_name, "str", pattern=r"^(?=.{5,100}$)[^0-9][A-Za-z0-9]+(?:-[A-Za-z0-9]+)*$"
        ),
    }
...
def build_revoke_certificate_request(
    resource_group_name: str, account_name: str, profile_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class CertificateProfilesOperations:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either CertificateProfile or the result of
         cls(response)
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.trustedsigning.models.CertificateProfile or IO[bytes]
        :return: An instance of LROPoller that returns either CertificateProfile or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.trustedsigning.models.CertificateProfile]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    def revoke_certificate(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.trustedsigning.models.RevokeCertificate or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
