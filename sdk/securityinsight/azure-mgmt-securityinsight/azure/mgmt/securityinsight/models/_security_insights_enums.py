...
class AuthenticationArmType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class ConfigurationArmType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class HttpsConfigurationArmType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class IngestionArmType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Types of ingestion."""
...
class KeyVaultAuthType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """KeyVaultAuthType."""
...
class LogArmType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class LogStatusArmType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Types of log status."""
...
class PerformActionKind(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class SapSystemArmType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Represents the types of SAP systems."""

    NET_WEAVER = "NetWeaver"
    JAVA_OS = "JavaOs"
    SAP_CONTROL_OS = "SapControlOs"
