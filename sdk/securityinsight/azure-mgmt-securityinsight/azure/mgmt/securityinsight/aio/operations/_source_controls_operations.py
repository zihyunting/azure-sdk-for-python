...
class SourceControlsOperations:
    ...
    async def delete(
        ...
        workspace_name: str,
        source_control_id: str,
        repository_access: Union[_models.RepositoryAccessProperties, IO],
        **kwargs: Any
    ) -> _models.Warning:
        """Delete a source control.
        ...
        :param repository_access: The repository access credentials. Is either a
         RepositoryAccessProperties type or a IO type. Required.
        :type repository_access: ~azure.mgmt.securityinsight.models.RepositoryAccessProperties or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        deserialized = self._deserialize("Warning", pipeline_response)
    ...
    delete.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/sourcecontrols/{sourceControlId}/delete"
    }
