...
def build_create_or_update_request(
    ...
    **kwargs: Any
    ...
    # Construct headers
    if x_ms_client_workspace_id is not None:
        _headers["x-ms-client-workspace-id"] = _SERIALIZER.header(
            "x_ms_client_workspace_id", x_ms_client_workspace_id, "str"
        )
    if x_ms_client_object_id is not None:
        _headers["x-ms-client-object-id"] = _SERIALIZER.header("x_ms_client_object_id", x_ms_client_object_id, "str")
...
def build_perform_action_request(
    resource_group_name: str,
    workspace_name: str,
    agent_resource_name: str,
    system_resource_name: str,
...
class SystemsOperations:
    ...
    def create_or_update(
        ...
        x_ms_client_workspace_id: Optional[str] = None,
        x_ms_client_object_id: Optional[str] = None,
        system_to_upsert: Optional[_models.System] = None,
        *,
        ...
        **kwargs: Any
        ...
        :type system_to_upsert: ~azure.mgmt.securityinsight.models.System
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: System or the result of cls(response)
        :rtype: ~azure.mgmt.securityinsight.models.System
    ...
    def create_or_update(
        ...
        x_ms_client_workspace_id: Optional[str] = None,
        x_ms_client_object_id: Optional[str] = None,
        system_to_upsert: Optional[IO] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.System:
    ...
    def create_or_update(
        ...
        x_ms_client_workspace_id: Optional[str] = None,
        x_ms_client_object_id: Optional[str] = None,
        system_to_upsert: Optional[Union[_models.System, IO]] = None,
        **kwargs: Any
    ) -> _models.System:
        """Creates or updates the system.
        ...
        :param x_ms_client_object_id: Default value is None.
        :type x_ms_client_object_id: str
        :param system_to_upsert: The system to upsert. Is either a System type or a IO type. Default
         value is None.
        :type system_to_upsert: ~azure.mgmt.securityinsight.models.System or IO
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.System] = kwargs.pop("cls", None)
        ...
        if isinstance(system_to_upsert, (IOBase, bytes)):
            ...
            if system_to_upsert is not None:
                _json = self._serialize.body(system_to_upsert, "System")
            else:
                _json = None
        ...
        if response.status_code == 200:
            deserialized = self._deserialize("System", pipeline_response)
    ...
    create_or_update.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/businessApplicationAgents/{agentResourceName}/systems/{systemResourceName}"
    }
    ...
    def get_all(
        ...
        **kwargs: Any
        ...
        :type top: int
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either System or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.securityinsight.models.System]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    get_all.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/businessApplicationAgents/{agentResourceName}/systems"
    }
    ...
    def list_actions(
        ...
        **kwargs: Any
        ...
        :type system_resource_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ListActionsResponse or the result of cls(response)
        :rtype: ~azure.mgmt.securityinsight.models.ListActionsResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        request = build_list_actions_request(
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            agent_resource_name=agent_resource_name,
            system_resource_name=system_resource_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.list_actions.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    list_actions.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/businessApplicationAgents/{agentResourceName}/systems/{systemResourceName}/listActions"
    }
    ...
    def perform_action(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_perform_action_request(
            ...
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.perform_action.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    perform_action.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/businessApplicationAgents/{agentResourceName}/systems/{systemResourceName}/performAction"
    }
    ...
    def report_action_status(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        request = build_report_action_status_request(
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            agent_resource_name=agent_resource_name,
            system_resource_name=system_resource_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.report_action_status.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    report_action_status.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/businessApplicationAgents/{agentResourceName}/systems/{systemResourceName}/reportActionStatus"
    }
