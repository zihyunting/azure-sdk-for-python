...
def build_get_request(
    resource_group_name: str, patch_name: str, subscription_id: str, container_app_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ContainerAppsPatchesOperations:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_container_app_request(
                    ...
                    container_app_name=self._config.container_app_name,
                    filter=filter,
    ...
    @distributed_trace
    def get(self, resource_group_name: str, patch_name: str, **kwargs: Any) -> _models.ContainerAppsPatchResource:
    ...
    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, patch_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    @distributed_trace
    def begin_delete(self, resource_group_name: str, patch_name: str, **kwargs: Any) -> LROPoller[None]:
