...
def build_list_request(
    resource_group_name: str, subscription_id: str, container_app_name: str, **kwargs: Any
) -> HttpRequest:
...
class ContainerAppsBuildsByContainerAppOperations:  # pylint: disable=name-too-long
    ...
    @distributed_trace
    def list(self, resource_group_name: str, **kwargs: Any) -> Iterable["_models.ContainerAppsBuildResource"]:
