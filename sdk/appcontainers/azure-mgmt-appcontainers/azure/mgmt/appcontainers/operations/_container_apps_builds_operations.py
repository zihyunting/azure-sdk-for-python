...
def build_get_request(
    resource_group_name: str, build_name: str, subscription_id: str, container_app_name: str, **kwargs: Any
) -> HttpRequest:
...
class ContainerAppsBuildsOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, build_name: str, **kwargs: Any) -> _models.ContainerAppsBuildResource:
    ...
    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, build_name: str, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    @distributed_trace
    def begin_delete(self, resource_group_name: str, build_name: str, **kwargs: Any) -> LROPoller[None]:
