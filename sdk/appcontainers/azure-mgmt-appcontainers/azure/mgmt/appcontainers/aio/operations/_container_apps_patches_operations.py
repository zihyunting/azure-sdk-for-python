...
class ContainerAppsPatchesOperations:
    ...
    async def get(self, resource_group_name: str, patch_name: str, **kwargs: Any) -> _models.ContainerAppsPatchResource:
    ...
    @distributed_trace_async
    async def begin_delete(self, resource_group_name: str, patch_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
