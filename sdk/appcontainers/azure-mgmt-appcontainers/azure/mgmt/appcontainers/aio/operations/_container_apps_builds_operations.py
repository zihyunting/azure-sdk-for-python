...
class ContainerAppsBuildsOperations:
    ...
    async def get(self, resource_group_name: str, build_name: str, **kwargs: Any) -> _models.ContainerAppsBuildResource:
    ...
    @distributed_trace_async
    async def begin_delete(self, resource_group_name: str, build_name: str, **kwargs: Any) -> AsyncLROPoller[None]:
