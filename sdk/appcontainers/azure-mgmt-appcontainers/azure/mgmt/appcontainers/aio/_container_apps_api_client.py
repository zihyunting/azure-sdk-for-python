...
class ContainerAppsAPIClient(
    ...
    :ivar app_space_resources: AppSpaceResourcesOperations operations
    :vartype app_space_resources:
     azure.mgmt.appcontainers.aio.operations.AppSpaceResourcesOperations
    :ivar app_spaces: AppSpacesOperations operations
    :vartype app_spaces: azure.mgmt.appcontainers.aio.operations.AppSpacesOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.app_space_resources = AppSpaceResourcesOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
        self.app_spaces = AppSpacesOperations(self._client, self._config, self._serialize, self._deserialize)
