...
class ContainerExecutionStatus(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype code: int
        :keyword reason: Container reason.
...
class ExecutionStatus(_serialization.Model):
    ...
    :ivar pods: Pods in the execution.
    :vartype pods: list[~azure.mgmt.appcontainers.models.PodExecutionStatus]
    """

    _attribute_map = {
        "pods": {"key": "pods", "type": "[PodExecutionStatus]"},
    }

    def __init__(self, *, pods: Optional[List["_models.PodExecutionStatus"]] = None, **kwargs: Any) -> None:
        """
        :keyword pods: Pods in the execution.
        :paramtype pods: list[~azure.mgmt.appcontainers.models.PodExecutionStatus]
        """
        super().__init__(**kwargs)
        self.pods = pods
...
class PodExecutionStatus(_serialization.Model):
    """Container Apps Job execution pod status.

    :ivar name: Pod Name.
    :vartype name: str
    :ivar containers: Containers in the execution.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword name: Pod Name.
        :paramtype name: str
        :keyword containers: Containers in the execution.
