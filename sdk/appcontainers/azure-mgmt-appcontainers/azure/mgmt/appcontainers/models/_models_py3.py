...
class AppSpace(TrackedResourceAutoGenerated):
    """App Space.
    ...
    :ivar location: The geo-location where the resource lives. Required.
    :vartype location: str
    :ivar properties: AppSpace resource specific properties.
    :vartype properties: ~azure.mgmt.appcontainers.models.AppSpaceProperties
    """
    ...
    _attribute_map = {
        ...
        "tags": {"key": "tags", "type": "{str}"},
        "location": {"key": "location", "type": "str"},
        "properties": {"key": "properties", "type": "AppSpaceProperties"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        properties: Optional["_models.AppSpaceProperties"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword tags: Resource tags.
        ...
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
        :keyword properties: AppSpace resource specific properties.
        :paramtype properties: ~azure.mgmt.appcontainers.models.AppSpaceProperties
        """
        super().__init__(tags=tags, location=location, **kwargs)
        self.properties = properties


class AppSpacePatch(ResourceAutoGenerated):
    """AppSpace patch object - Patch is done via a json merge and does not require all parameters for
...
class AppSpaceProperties(_serialization.Model):
    """AppSpace resource specific properties.

    :ivar friendly_name: Friendly name of the App Space.
    :vartype friendly_name: str
    :ivar primary_resource_id: Optional - ARM resource Id of the primary App Space Resource in the
     App Space. Used by Portal UX if present.
    ...
    def __init__(
        self, *, friendly_name: Optional[str] = None, primary_resource_id: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword friendly_name: Friendly name of the App Space.
        :paramtype friendly_name: str
        :keyword primary_resource_id: Optional - ARM resource Id of the primary App Space Resource in
         the App Space. Used by Portal UX if present.
        :paramtype primary_resource_id: str
        """
        super().__init__(**kwargs)
        self.friendly_name = friendly_name
        self.primary_resource_id = primary_resource_id


class AppSpaceResource(TrackedResourceAutoGenerated):
    """App Space Resource.
    ...
    :ivar location: The geo-location where the resource lives. Required.
    :vartype location: str
    :ivar properties: AppSpaceResource resource-specific properties.
    :vartype properties: ~azure.mgmt.appcontainers.models.AppSpaceResourceProperties
    """
    ...
    _attribute_map = {
        ...
        "tags": {"key": "tags", "type": "{str}"},
        "location": {"key": "location", "type": "str"},
        "properties": {"key": "properties", "type": "AppSpaceResourceProperties"},
    }
    ...
    def __init__(
        ...
        *,
        location: str,
        tags: Optional[Dict[str, str]] = None,
        properties: Optional["_models.AppSpaceResourceProperties"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword tags: Resource tags.
        ...
        :keyword location: The geo-location where the resource lives. Required.
        :paramtype location: str
        :keyword properties: AppSpaceResource resource-specific properties.
        :paramtype properties: ~azure.mgmt.appcontainers.models.AppSpaceResourceProperties
        """
        super().__init__(tags=tags, location=location, **kwargs)
        self.properties = properties


class AppSpaceResourcePatch(ResourceAutoGenerated):
    """AppSpaceResource patch object - Patch is done via a json merge and does not require all
    parameters for TrackedResource (i.e. location) to be present.
...
class AppSpaceResourceProperties(_serialization.Model):
    """AppSpaceResource resource-specific properties.

    :ivar resource_id: ARM resource Id of the tracked resource.
    :vartype resource_id: str
    :ivar friendly_name: Friendly name of the App Space Resource.
    :vartype friendly_name: str
    :ivar resource_location: Location of the tracked ARM resource. Can be different from the
     location of the app space resource.
    :vartype resource_location: str
    :ivar repo: Optional App Space Resource Repository Information.
    :vartype repo: ~azure.mgmt.appcontainers.models.RepositoryInformation
    :ivar deployment: Optional App Space Resource Deployment Information.
    :vartype deployment: ~azure.mgmt.appcontainers.models.DeploymentInformation
    :ivar app_space_resource_label: Enum marking whether or not this App Space Resource is a
     favorite (values are Default, Favorite). Known values are: "Default" and "Favorite".
    :vartype app_space_resource_label: str or
     ~azure.mgmt.appcontainers.models.AppSpaceResourceLabel
    :ivar metadata: Property bag - array that contains the properties (name/value) used by Portal
     UX.
    :vartype metadata: list[~azure.mgmt.appcontainers.models.MetadataProperty]
    :ivar dependencies: List of ARM App Space Resource Ids on which this App Space Resource is
     dependent.
    ...
    _attribute_map = {
        ...
        "repo": {"key": "repo", "type": "RepositoryInformation"},
        "deployment": {"key": "deployment", "type": "DeploymentInformation"},
        "app_space_resource_label": {"key": "appSpaceResourceLabel", "type": "str"},
        "metadata": {"key": "metadata", "type": "[MetadataProperty]"},
    ...
    def __init__(
        ...
        *,
        ...
        repo: Optional["_models.RepositoryInformation"] = None,
        deployment: Optional["_models.DeploymentInformation"] = None,
        app_space_resource_label: Union[str, "_models.AppSpaceResourceLabel"] = "Default",
        metadata: Optional[List["_models.MetadataProperty"]] = None,
        dependencies: Optional[List[str]] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword resource_id: ARM resource Id of the tracked resource.
        :paramtype resource_id: str
        :keyword friendly_name: Friendly name of the App Space Resource.
        :paramtype friendly_name: str
        :keyword resource_location: Location of the tracked ARM resource. Can be different from the
         location of the app space resource.
        :paramtype resource_location: str
        :keyword repo: Optional App Space Resource Repository Information.
        :paramtype repo: ~azure.mgmt.appcontainers.models.RepositoryInformation
        :keyword deployment: Optional App Space Resource Deployment Information.
        :paramtype deployment: ~azure.mgmt.appcontainers.models.DeploymentInformation
        :keyword app_space_resource_label: Enum marking whether or not this App Space Resource is a
         favorite (values are Default, Favorite). Known values are: "Default" and "Favorite".
        :paramtype app_space_resource_label: str or
         ~azure.mgmt.appcontainers.models.AppSpaceResourceLabel
        :keyword metadata: Property bag - array that contains the properties (name/value) used by
         Portal UX.
        :paramtype metadata: list[~azure.mgmt.appcontainers.models.MetadataProperty]
        :keyword dependencies: List of ARM App Space Resource Ids on which this App Space Resource is
         dependent.
        ...
        self.app_space_resource_label = app_space_resource_label
        self.metadata = metadata
        self.dependencies = dependencies


class AppSpaceResourcesCollection(_serialization.Model):
    ...
    :ivar value: Collection of resources. Required.
    :vartype value: list[~azure.mgmt.appcontainers.models.AppSpaceResource]
    :ivar next_link: Link to next page of resources.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[AppSpaceResource]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(self, *, value: List["_models.AppSpaceResource"], **kwargs: Any) -> None:
        """
        :keyword value: Collection of resources. Required.
        :paramtype value: list[~azure.mgmt.appcontainers.models.AppSpaceResource]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class AppSpacesCollection(_serialization.Model):
    ...
    :ivar value: Collection of resources. Required.
    :vartype value: list[~azure.mgmt.appcontainers.models.AppSpace]
    :ivar next_link: Link to next page of resources.
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[AppSpace]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }

    def __init__(self, *, value: List["_models.AppSpace"], **kwargs: Any) -> None:
        """
        :keyword value: Collection of resources. Required.
        :paramtype value: list[~azure.mgmt.appcontainers.models.AppSpace]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class DeploymentInformation(_serialization.Model):
    """App Space Resource Deployment Information - used to track the deployment information for an App
    Space Resource's tracked ARM resource.

    :ivar id: ARM Id of the deployment.
    :vartype id: str
    :ivar provisioning_state: Provisioning State for the deployment.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword id: ARM Id of the deployment.
        :paramtype id: str
        :keyword provisioning_state: Provisioning State for the deployment.
...
class MetadataProperty(_serialization.Model):
...
class RepositoryInformation(_serialization.Model):
    """App Space Resource Repository Information - used to track the github repository for an App
    Space Resource's tracked ARM resource.

    :ivar url: url for the repository.
    :vartype url: str
    :ivar branch: branch in the repository.
    :vartype branch: str
    """
    ...
    def __init__(self, *, url: Optional[str] = None, branch: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword url: url for the repository.
        :paramtype url: str
        :keyword branch: branch in the repository.
