...
class EnvironmentVariableCollection(_serialization.Model):
    """Environment variables to update.

    :ivar environment_variables: Collection of environment variables.
    :vartype environment_variables: list[~azure.mgmt.appcontainers.models.EnvironmentVariablesItem]
    """

    _attribute_map = {
        "environment_variables": {"key": "environmentVariables", "type": "[EnvironmentVariablesItem]"},
    }

    def __init__(
        self, *, environment_variables: Optional[List["_models.EnvironmentVariablesItem"]] = None, **kwargs: Any
    ) -> None:
        """
        :keyword environment_variables: Collection of environment variables.
        :paramtype environment_variables:
         list[~azure.mgmt.appcontainers.models.EnvironmentVariablesItem]
        """
        super().__init__(**kwargs)
        self.environment_variables = environment_variables


class EnvironmentVariablesItem(_serialization.Model):
    """An item of the environment variables collection.

    :ivar key: The key of the item.
    :vartype key: str
    :ivar value: The value of the item.
    :vartype value: list[~azure.mgmt.appcontainers.models.EnvironmentVar]
    """

    _attribute_map = {
        "key": {"key": "key", "type": "str"},
        "value": {"key": "value", "type": "[EnvironmentVar]"},
    }

    def __init__(
        self, *, key: Optional[str] = None, value: Optional[List["_models.EnvironmentVar"]] = None, **kwargs: Any
    ) -> None:
        """
        :keyword key: The key of the item.
        :paramtype key: str
        :keyword value: The value of the item.
        :paramtype value: list[~azure.mgmt.appcontainers.models.EnvironmentVar]
        """
        super().__init__(**kwargs)
        self.key = key
        self.value = value
...
class Session(ProxyResourceAutoGenerated):  # pylint: disable=too-many-instance-attributes
    """Session resource.
    ...
    :ivar count: The number of Sessions to generate.
    :vartype count: int
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword count: The number of Sessions to generate.
        :paramtype count: int
...
class SessionPool(TrackedResourceAutoGenerated):  # pylint: disable=too-many-instance-attributes
