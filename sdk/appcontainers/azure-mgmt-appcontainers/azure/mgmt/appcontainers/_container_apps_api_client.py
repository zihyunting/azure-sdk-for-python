...
class ContainerAppsAPIClient(
    ...
    :vartype app_space_resources: azure.mgmt.appcontainers.operations.AppSpaceResourcesOperations
    :ivar app_spaces: AppSpacesOperations operations
    :vartype app_spaces: azure.mgmt.appcontainers.operations.AppSpacesOperations
