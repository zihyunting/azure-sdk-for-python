...
class MachinesOperations:
    ...
    def create_or_update(
        ...
        resource_group_name: str,
        machine_name: str,
        parameters: Union[_models.Machine, IO],
        expand: Optional[str] = None,
        **kwargs: Any
    ) -> _models.Machine:
        """The operation to create or update a hybrid machine. Please note some properties can be set only
        ...
        :param parameters: Parameters supplied to the Create hybrid machine operation. Is either a
         Machine type or a IO type. Required.
        :type parameters: ~azure.mgmt.hybridcompute.models.Machine or IO
        :param expand: Expands referenced resources. Default value is None.
        :type expand: str
    ...
    @distributed_trace
    def update(
        self, resource_group_name: str, machine_name: str, parameters: Union[_models.MachineUpdate, IO], **kwargs: Any
    ) -> _models.Machine:
        """The operation to update a hybrid machine.
        ...
        :param parameters: Parameters supplied to the Update hybrid machine operation. Is either a
         MachineUpdate type or a IO type. Required.
        :type parameters: ~azure.mgmt.hybridcompute.models.MachineUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
