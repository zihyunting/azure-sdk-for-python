...
class DocumentTranslationClientOperationsMixin(DocumentTranslationClientMixinABC):
    ...
    @distributed_trace_async
    async def get_supported_formats(self, *, type: str, **kwargs: Any) -> _models.SupportedFileFormats:
        ...
        :keyword type: the type of format like document or glossary. Required.
        :paramtype type: str
