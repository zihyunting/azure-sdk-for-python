...
def build_delete_request(
    resource_group_name: str, account_name: str, subscription_id: str, *, soft_delete: bool = True, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class AccountsOperations:
    ...
    def _delete_initial(  # pylint: disable=inconsistent-return-statements
        self, resource_group_name: str, account_name: str, soft_delete: bool = True, **kwargs: Any
    ) -> None:
        error_map = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    def begin_delete(
        ...
        :param account_name: The name of the account. Required.
        :type account_name: str
        :param soft_delete: The softDelete flag. Indicates if account should be soft deleted or hard
         deleted. Default value is True.
