...
class SubscriptionScopeMetricsRequestBodyParameters(
    ...
    :vartype interval: ~datetime.timedelta
    :ivar metric_names: The names of the metrics (comma separated) to retrieve. Special case: If a
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype interval: ~datetime.timedelta
        :keyword metric_names: The names of the metrics (comma separated) to retrieve. Special case: If
