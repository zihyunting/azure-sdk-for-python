...
class AutomaticOsUpgradePolicy(_model_base.Model):
    ...
    :ivar enable_automatic_o_s_upgrade: Indicates whether OS upgrades should automatically be
    ...
    :vartype enable_automatic_o_s_upgrade: bool
    ...
    enable_automatic_o_s_upgrade: Optional[bool] = rest_field(name="enableAutomaticOsUpgrade")
    ...
    def __init__(
        ...
        *,
        ...
        enable_automatic_o_s_upgrade: Optional[bool] = None,
...
class BatchNodeCounts(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype total: int
    :ivar upgrading_o_s: The number of Compute Nodes in the upgradingOS state. Required.
    :vartype upgrading_o_s: int
    """
    ...
    upgrading_o_s: int = rest_field(name="upgradingOs")
...
class UpgradePolicy(_model_base.Model):
    ...
    :ivar automatic_o_s_upgrade_policy: Configuration parameters used for performing automatic OS
     Upgrade. The configuration parameters used for performing automatic OS upgrade.
    :vartype automatic_o_s_upgrade_policy: ~azure.batch.models.AutomaticOsUpgradePolicy
    ...
    automatic_o_s_upgrade_policy: Optional["_models.AutomaticOsUpgradePolicy"] = rest_field(
    ...
    def __init__(
        ...
        *,
        ...
        automatic_o_s_upgrade_policy: Optional["_models.AutomaticOsUpgradePolicy"] = None,
