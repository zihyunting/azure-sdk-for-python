...
def build_list_by_report_resource_request(
    report_name: str,
    *,
...
class SnapshotResourcesOperations:
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_report_resource_request(
                    ...
                    template_url=self.list_by_report_resource.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
    ...
    list_by_report_resource.metadata = {
    ...
    get.metadata = {"url": "/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/snapshots/{snapshotName}"}

    def _download_initial(
        self, report_name: str, snapshot_name: str, body: Union[_models.SnapshotDownloadRequest, IO], **kwargs: Any
    ...
    _download_initial.metadata = {
        "url": "/providers/Microsoft.AppComplianceAutomation/reports/{reportName}/snapshots/{snapshotName}/download"
    }
    ...
    @overload
    def begin_download(
        self, report_name: str, snapshot_name: str, body: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> LROPoller[_models.DownloadResponse]:
        """Download compliance needs from snapshot, like: Compliance Report, Resource List.
    ...
    def begin_download(
        ...
        :param snapshot_name: Snapshot Name. Required.
        :type snapshot_name: str
        :param body: The content of the action request. Is either a SnapshotDownloadRequest type or a
         IO type. Required.
        :type body: ~azure.mgmt.appcomplianceautomation.models.SnapshotDownloadRequest or IO
