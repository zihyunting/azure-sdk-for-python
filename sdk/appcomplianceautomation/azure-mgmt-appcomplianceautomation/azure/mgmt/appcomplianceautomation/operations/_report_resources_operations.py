...
def build_list_by_tenant_request(
    ...
    **kwargs: Any
    ...
    api_version: str = kwargs.pop("api_version", _params.pop("api-version", "2022-11-16-preview"))
...
class ReportResourcesOperations:
    ...
    list_by_tenant.metadata = {"url": "/providers/Microsoft.AppComplianceAutomation/reports"}
    ...
    def _create_or_update_initial(
        self, report_name: str, resource: Union[_models.ReportResource, IO], **kwargs: Any
    ...
    @overload
    def begin_create_or_update(
        self, report_name: str, resource: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> LROPoller[_models.ReportResource]:
        """Create a new AppComplianceAutomation report or update an exiting AppComplianceAutomation
        report.
    ...
    def begin_create_or_update(
        ...
        :param report_name: Report Name. Required.
        :type report_name: str
        :param resource: Resource create parameters. Is either a ReportResource type or a IO type.
         Required.
        :type resource: ~azure.mgmt.appcomplianceautomation.models.ReportResource or IO
    ...
    def _update_initial(
        self, report_name: str, properties: Union[_models.ReportResourceUpdate, IO], **kwargs: Any
        ...
        if isinstance(properties, (IOBase, bytes)):
            ...
            _json = self._serialize.body(properties, "ReportResourceUpdate")
    ...
    def begin_update(
        self,
        report_name: str,
        properties: _models.ReportResourceUpdate,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.ReportResource]:
        ...
        :type properties: ~azure.mgmt.appcomplianceautomation.models.ReportResourceUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    @overload
    def begin_update(
        self, report_name: str, properties: IO, *, content_type: str = "application/json", **kwargs: Any
    ) -> LROPoller[_models.ReportResource]:
        """Update an exiting AppComplianceAutomation report.
    ...
    def begin_update(
        ...
        :param report_name: Report Name. Required.
        :type report_name: str
        :param properties: The resource properties to be updated. Is either a ReportResourceUpdate type
         or a IO type. Required.
        :type properties: ~azure.mgmt.appcomplianceautomation.models.ReportResourceUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
