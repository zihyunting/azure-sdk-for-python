...
def build_create_request(
    resource_group_name: str, network_packet_broker_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    ...
    path_format_arguments = {
        ...
        "networkPacketBrokerName": _SERIALIZER.url("network_packet_broker_name", network_packet_broker_name, "str"),
    }
...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.ManagedNetworkFabric/networkPacketBrokers"
    )  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
    }
...
class NetworkPacketBrokersOperations:
    ...
    def begin_create(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.NetworkPacketBroker]:
        ...
        :return: An instance of LROPoller that returns either NetworkPacketBroker or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.managednetworkfabric.models.NetworkPacketBroker]
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.NetworkPacketBroker].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.NetworkPacketBroker](
    ...
    @distributed_trace
    def begin_delete(self, resource_group_name: str, network_packet_broker_name: str, **kwargs: Any) -> LROPoller[None]:
    ...
    def list_by_resource_group(
    ...
    ) -> Iterable["_models.NetworkPacketBroker"]:
        ...
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.managednetworkfabric.models.NetworkPacketBroker]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.NetworkPacketBroker"]:
