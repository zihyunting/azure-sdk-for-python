...
from ...operations._ip_prefixes_operations import (
...
class IpPrefixesOperations:
    ...
    async def _create_initial(
        self, resource_group_name: str, ip_prefix_name: str, body: Union[_models.IpPrefix, IO[bytes]], **kwargs: Any
    ) -> _models.IpPrefix:
        error_map = {
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :return: An instance of AsyncLROPoller that returns either IpPrefix or the result of
         cls(response)
    ...
    async def begin_create(
        ...
        :param ip_prefix_name: Name of the IP Prefix. Required.
        :type ip_prefix_name: str
        :param body: Request payload. Is either a IpPrefix type or a IO[bytes] type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.IpPrefix or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either IpPrefix or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.IpPrefix]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        ip_prefix_name: str,
        body: Union[_models.IpPrefixPatch, IO[bytes]],
        **kwargs: Any
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :param ip_prefix_name: Name of the IP Prefix. Required.
        :type ip_prefix_name: str
        :param body: IP Prefix properties to update. Is either a IpPrefixPatch type or a IO[bytes]
         type. Required.
        :type body: ~azure.mgmt.managednetworkfabric.models.IpPrefixPatch or IO[bytes]
        :return: An instance of AsyncLROPoller that returns either IpPrefix or the result of
         cls(response)
        :rtype: ~azure.core.polling.AsyncLROPoller[~azure.mgmt.managednetworkfabric.models.IpPrefix]
        :raises ~azure.core.exceptions.HttpResponseError:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.IpPrefix"]:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> AsyncIterable["_models.IpPrefix"]:
