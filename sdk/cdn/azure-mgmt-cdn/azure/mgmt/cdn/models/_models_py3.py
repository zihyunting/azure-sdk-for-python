...
class Profile(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype log_scrubbing: ~azure.mgmt.cdn.models.ProfilePropertiesLogScrubbing
    """
    ...
    _attribute_map = {
        ...
        "log_scrubbing": {"key": "properties.logScrubbing", "type": "ProfilePropertiesLogScrubbing"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        log_scrubbing: Optional["_models.ProfilePropertiesLogScrubbing"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword location: Resource location. Required.
        ...
        :paramtype log_scrubbing: ~azure.mgmt.cdn.models.ProfilePropertiesLogScrubbing
        """
        super().__init__(location=location, tags=tags, **kwargs)
        self.sku = sku
        self.kind = None
...
class ProfilePropertiesLogScrubbing(_serialization.Model):
    ...
    :ivar scrubbing_rules: List of log scrub rules applied to logs.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword scrubbing_rules: List of log scrub rules applied to logs.
...
class ProfilePropertiesUpdateParametersLogScrubbing(_serialization.Model):
    """Defines rules to scrub sensitive fields in logs.
...
class ProfileScrubbingRules(_serialization.Model):
    ...
    :ivar selector_match_operator: Comparison type to use for matching with the variable value in
     log. Required. "EqualsAny"
    :vartype selector_match_operator: str or ~azure.mgmt.cdn.models.ScrubbingRuleEntryMatchOperator
    :ivar selector: Match against a specific key from the QueryString variables in the log. Default
     value is null.
    :vartype selector: str
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword selector_match_operator: Comparison type to use for matching with the variable value
         in log. Required. "EqualsAny"
        :paramtype selector_match_operator: str or
         ~azure.mgmt.cdn.models.ScrubbingRuleEntryMatchOperator
        :keyword selector: Match against a specific key from the QueryString variables in the log.
...
class ProfileUpdateParameters(_serialization.Model):
    ...
    :vartype origin_response_timeout_seconds: int
    :ivar log_scrubbing: Defines rules to scrub sensitive fields in logs.
    :vartype log_scrubbing: ~azure.mgmt.cdn.models.ProfilePropertiesUpdateParametersLogScrubbing
    """
    ...
    _attribute_map = {
        ...
        "identity": {"key": "identity", "type": "ManagedServiceIdentity"},
        "origin_response_timeout_seconds": {"key": "properties.originResponseTimeoutSeconds", "type": "int"},
        "log_scrubbing": {"key": "properties.logScrubbing", "type": "ProfilePropertiesUpdateParametersLogScrubbing"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        identity: Optional["_models.ManagedServiceIdentity"] = None,
        origin_response_timeout_seconds: Optional[int] = None,
        log_scrubbing: Optional["_models.ProfilePropertiesUpdateParametersLogScrubbing"] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :paramtype origin_response_timeout_seconds: int
        :keyword log_scrubbing: Defines rules to scrub sensitive fields in logs.
        :paramtype log_scrubbing: ~azure.mgmt.cdn.models.ProfilePropertiesUpdateParametersLogScrubbing
        """
        super().__init__(**kwargs)
        self.tags = tags
        self.identity = identity
