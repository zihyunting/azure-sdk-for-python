...
class Identity(_serialization.Model):
    ...
    :ivar type: The type of identity used for the Streaming Job. Known values are: "SystemAssigned"
     and "None".
    :vartype type: str or ~azure.mgmt.streamanalytics.models.ResourceIdentityType
    """
    ...
    def __init__(self, *, type: Optional[Union[str, "_models.ResourceIdentityType"]] = None, **kwargs: Any) -> None:
        """
        :keyword type: The type of identity used for the Streaming Job. Known values are:
         "SystemAssigned" and "None".
        :paramtype type: str or ~azure.mgmt.streamanalytics.models.ResourceIdentityType
        """
        super().__init__(**kwargs)
        self.tenant_id = None
