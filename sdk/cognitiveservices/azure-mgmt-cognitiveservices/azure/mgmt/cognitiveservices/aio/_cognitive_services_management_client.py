...
class CognitiveServicesManagementClient(
    ...
    :vartype rai_blocklist: azure.mgmt.cognitiveservices.aio.operations.RaiBlocklistOperations
    :ivar rai_blocklist_item: RaiBlocklistItemOperations operations
    :vartype rai_blocklist_item:
     azure.mgmt.cognitiveservices.aio.operations.RaiBlocklistItemOperations
