...
def build_list_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "labName": _SERIALIZER.url("lab_name", lab_name, "str", max_length=50, min_length=1, pattern=r"^[a-z0-9_\-]+$"),
        "artifactSourceName": _SERIALIZER.url(
            "artifact_source_name", artifact_source_name, "str", max_length=260, min_length=1, pattern=r"^[a-z0-9_\-]+$"
        ),
    }
