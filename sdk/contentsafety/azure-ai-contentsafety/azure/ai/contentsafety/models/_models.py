...
class AnalyzeTextOptions(_model_base.Model):
    ...
    :ivar customized_categories: Customized categories will be analyzed if they are assigned. If no
     customized categories are assigned, no analysis on them will be returned.
    :vartype customized_categories: list[~azure.ai.contentsafety.models.CustomizedCategoryOption]
    """
    ...
    """This refers to the type of text analysis output. If no value is assigned, the default value
     ...
     \"EightSeverityLevels\"."""
    customized_categories: Optional[List["_models.CustomizedCategoryOption"]] = rest_field(name="customizedCategories")
    """Customized categories will be analyzed if they are assigned. If no customized categories are
     assigned, no analysis on them will be returned."""
    ...
    def __init__(
        ...
        *,
        ...
        customized_categories: Optional[List["_models.CustomizedCategoryOption"]] = None,
    ):
        ...
...
class AnalyzeTextResult(_model_base.Model):
    ...
    :ivar text_customized_categories_analysis: Analysis result for text customized categories.
    :vartype text_customized_categories_analysis:
     list[~azure.ai.contentsafety.models.TextCustomizedCategoriesAnalysis]
    """
    ...
    """Analysis result for categories. Required."""
    text_customized_categories_analysis: Optional[List["_models.TextCustomizedCategoriesAnalysis"]] = rest_field(
        name="textCustomizedCategoriesAnalysis"
    )
    """Analysis result for text customized categories."""
    ...
    def __init__(
        ...
        *,
        ...
        text_customized_categories_analysis: Optional[List["_models.TextCustomizedCategoriesAnalysis"]] = None,
    ):
        ...
...
class CustomizedCategoryOption(_model_base.Model):
    """The custom category option for text.

    All required parameters must be populated in order to send to server.

    :ivar category_name: Name. Required.
    :vartype category_name: str
    :ivar version: custom category version for inference. Required.
    :vartype version: int
    """

    category_name: str = rest_field(name="categoryName")
    """Name. Required."""
    version: int = rest_field()
    """custom category version for inference. Required."""
...
class TextCustomizedCategoriesAnalysis(_model_base.Model):
    """Analysis result for text customized categories.

    All required parameters must be populated in order to send to server.

    :ivar category_name: Name of the custom category. Required.
    :vartype category_name: str
    :ivar detected: Whether the custom category is detected. Required.
    :vartype detected: bool
    """

    category_name: str = rest_field(name="categoryName")
    """Name of the custom category. Required."""
    detected: bool = rest_field()
    """Whether the custom category is detected. Required."""
