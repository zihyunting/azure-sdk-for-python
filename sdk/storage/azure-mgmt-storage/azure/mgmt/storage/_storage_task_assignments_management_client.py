...
from ._configuration import StorageTaskAssignmentsManagementClientConfiguration
...
class StorageTaskAssignmentsManagementClient(MultiApiClientMixin, _SDKClient):
    """The Azure Storage Task Assignments Management API.
    ...
    _PROFILE_TAG = "azure.mgmt.storage.StorageTaskAssignmentsManagementClient"
    LATEST_PROFILE = ProfileDefinition({
        _PROFILE_TAG: {
            None: DEFAULT_API_VERSION,
            'blob_containers': '2023-01-01',
            'blob_inventory_policies': '2023-01-01',
            'blob_services': '2023-01-01',
            'deleted_accounts': '2023-01-01',
            'encryption_scopes': '2023-01-01',
            'file_services': '2023-01-01',
            'file_shares': '2023-01-01',
            'local_users': '2023-01-01',
            'management_policies': '2023-01-01',
            'object_replication_policies': '2023-01-01',
            'operations': '2023-01-01',
            'private_endpoint_connections': '2023-01-01',
            'private_link_resources': '2023-01-01',
            'queue': '2023-01-01',
            'queue_services': '2023-01-01',
            'skus': '2023-01-01',
            'storage_accounts': '2023-01-01',
            'table': '2023-01-01',
            'table_services': '2023-01-01',
            'usage': '2018-02-01',
            'usages': '2023-01-01',
        }},
        _PROFILE_TAG + " latest"
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = StorageTaskAssignmentsManagementClientConfiguration(credential, subscription_id, **kwargs)
        ...
        super(StorageTaskAssignmentsManagementClient, self).__init__(
