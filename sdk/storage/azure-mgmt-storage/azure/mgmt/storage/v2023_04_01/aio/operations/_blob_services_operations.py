...
class BlobServicesOperations:
    ...
    def list(
        ...
        :return: An iterator like instance of either BlobServiceProperties or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.storage.v2023_04_01.models.BlobServiceProperties]
    ...
    async def set_service_properties(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2023_04_01.models.BlobServiceProperties
        ...
        :rtype: ~azure.mgmt.storage.v2023_04_01.models.BlobServiceProperties
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def set_service_properties(
        ...
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2023_04_01.models.BlobServiceProperties or IO
        :keyword blob_services_name: The name of the blob Service within the specified storage account.
         Blob Service Name must be 'default'. Default value is "default". Note that overriding this
         default value may result in unsupported behavior.
        :paramtype blob_services_name: str
