...
class StorageTaskAssignmentsManagementClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = StorageTaskAssignmentsManagementClientConfiguration(
    ...
    async def __aenter__(self) -> "StorageTaskAssignmentsManagementClient":
