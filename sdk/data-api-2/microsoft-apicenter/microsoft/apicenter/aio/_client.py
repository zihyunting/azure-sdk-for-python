...
class DataApiClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype models: microsoft.apicenter.aio.operations.ModelsOperations
    :ivar apis: ApisOperations operations
    :vartype apis: microsoft.apicenter.aio.operations.ApisOperations
    :ivar api_definitions: ApiDefinitionsOperations operations
    :vartype api_definitions: microsoft.apicenter.aio.operations.ApiDefinitionsOperations
    :ivar api_deployments: ApiDeploymentsOperations operations
    :vartype api_deployments: microsoft.apicenter.aio.operations.ApiDeploymentsOperations
    :ivar environments: EnvironmentsOperations operations
    :vartype environments: microsoft.apicenter.aio.operations.EnvironmentsOperations
    :ivar api_versions: ApiVersionsOperations operations
    :vartype api_versions: microsoft.apicenter.aio.operations.ApiVersionsOperations
