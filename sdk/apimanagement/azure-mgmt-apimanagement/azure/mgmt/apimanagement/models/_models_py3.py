...
class ApiContract(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar api_type: Type of API. Known values are: "http", "soap", "websocket", "graphql", and
     "odata".
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :paramtype subscription_key_parameter_names:
         ~azure.mgmt.apimanagement.models.SubscriptionKeyParameterNamesContract
        :keyword api_type: Type of API. Known values are: "http", "soap", "websocket", "graphql", and
         "odata".
...
class ApiCreateOrUpdateParameter(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar format: Format of the Content in which the API is getting imported. New formats can be
     ...
     "openapi+json-link", "graphql-link", "odata", and "odata-link".
...
class AuthorizationProviderContract(ProxyResource):
    ...
    :ivar credentials: Key and value pairs of custom credential parameter names and parameter
     types.
    :vartype credentials: JSON
    """
    ...
    _attribute_map = {
        ...
        "credentials": {"key": "properties.credentials", "type": "object"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        credentials: Optional[JSON] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :keyword credentials: Key and value pairs of custom credential parameter names and parameter
         types.
        :paramtype credentials: JSON
        """
        super().__init__(**kwargs)
        self.display_name = display_name
...
class SchemaContract(ProxyResource):
    ...
    :ivar content_type: Must be a valid a media type used in a Content-Type header as defined in
     ...
     ``application/vnd.ms-azure-apim.odata.schema``.
    :vartype content_type: str
