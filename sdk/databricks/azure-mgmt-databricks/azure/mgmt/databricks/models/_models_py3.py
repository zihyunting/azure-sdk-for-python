...
class AccessConnectorProperties(_serialization.Model):
    ...
    :ivar refered_by: List of workspaces referring this accessConnector.
...
class WorkspaceCustomParameters(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar enable_no_public_ip: Boolean indicating whether the public IP should be disabled. Default
     value is true.
    :vartype enable_no_public_ip: bool
    ...
    def __init__(
        ...
        *,
        ...
        enable_no_public_ip: Optional[bool] = None,
        ...
        **kwargs: Any
        ...
        :paramtype enable_no_public_ip: bool
