...
def build_patient_timeline_infer_patient_timeline_request(  # pylint: disable=name-too-long
    **kwargs: Any,
) -> HttpRequest:
...
class PatientTimelineClientOperationsMixin(PatientTimelineClientMixinABC):
    def _infer_patient_timeline_initial(
    ...
    def begin_infer_patient_timeline(
        ...
        :return: An instance of LROPoller that returns PatientTimelineInferenceResult. The
         PatientTimelineInferenceResult is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.LROPoller[~azure.healthinsights.patienttimeline.models.PatientTimelineInferenceResult]
    ...
    def begin_infer_patient_timeline(
        ...
        if cont_token is None:
            raw_result = self._infer_patient_timeline_initial(
        ...
        if cont_token:
            return LROPoller[_models.PatientTimelineInferenceResult].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.PatientTimelineInferenceResult](
