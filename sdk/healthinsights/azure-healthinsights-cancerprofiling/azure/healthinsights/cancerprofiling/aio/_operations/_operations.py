...
class CancerProfilingClientOperationsMixin(CancerProfilingClientMixinABC):
    ...
    async def begin_infer_cancer_profile(
    ...
    ) -> AsyncLROPoller[_models.OncoPhenotypeInferenceResult]:
        ...
        :return: An instance of AsyncLROPoller that returns OncoPhenotypeInferenceResult. The
         OncoPhenotypeInferenceResult is compatible with MutableMapping
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.healthinsights.cancerprofiling.models.OncoPhenotypeInferenceResult]
    ...
    async def begin_infer_cancer_profile(
        ...
        if cont_token:
            return AsyncLROPoller[_models.OncoPhenotypeInferenceResult].from_continuation_token(
