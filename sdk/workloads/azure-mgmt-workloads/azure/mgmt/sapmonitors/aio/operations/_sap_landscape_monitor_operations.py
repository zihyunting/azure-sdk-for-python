...
class SapLandscapeMonitorOperations:
    ...
    async def get(self, resource_group_name: str, monitor_name: str, **kwargs: Any) -> _models.SapLandscapeMonitor:
        ...
        :rtype: ~azure.mgmt.workloads.sapmonitors.models.SapLandscapeMonitor
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type sap_landscape_monitor_parameter:
         ~azure.mgmt.workloads.sapmonitors.models.SapLandscapeMonitor
    ...
    async def create(
        ...
        **kwargs: Any
        ...
        :type sap_landscape_monitor_parameter:
         ~azure.mgmt.workloads.sapmonitors.models.SapLandscapeMonitor or IO
    ...
    async def list(
        ...
        :rtype: ~azure.mgmt.workloads.sapmonitors.models.SapLandscapeMonitorListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
