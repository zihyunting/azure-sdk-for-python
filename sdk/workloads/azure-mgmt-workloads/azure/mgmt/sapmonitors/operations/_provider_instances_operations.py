...
def build_get_request(
    ...
    path_format_arguments = {
        ...
        "providerInstanceName": _SERIALIZER.url(
            "provider_instance_name", provider_instance_name, "str", pattern=r"^[a-zA-Z0-9-]+$"
        ),
    }
...
class ProviderInstancesOperations:
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :param provider_instance_name: Name of the provider instance. Required.
        :type provider_instance_name: str
        :param provider_instance_parameter: Request body representing a provider instance associated
         with a SAP monitor. Required.
        :type provider_instance_parameter: ~azure.mgmt.workloads.sapmonitors.models.ProviderInstance
    ...
    def begin_create(
        ...
        **kwargs: Any
        ...
        :type provider_instance_name: str
        :param provider_instance_parameter: Request body representing a provider instance associated
         with a SAP monitor. Is either a ProviderInstance type or a IO type. Required.
        :type provider_instance_parameter: ~azure.mgmt.workloads.sapmonitors.models.ProviderInstance or
         IO
