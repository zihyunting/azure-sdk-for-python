...
def build_widget_manager_list_widgets_request(
    *, top: Optional[int] = None, skip: Optional[int] = None, select: Optional[List[str]] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class WidgetManagerClientOperationsMixin(WidgetManagerClientMixinABC):
    ...
    def begin_delete_widget(self, widget_name: str, **kwargs: Any) -> LROPoller[_models.OperationStatusError]:
        ...
        :rtype: ~azure.core.polling.LROPoller[~azure.contosowidgetmanager.models.OperationStatusError]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
