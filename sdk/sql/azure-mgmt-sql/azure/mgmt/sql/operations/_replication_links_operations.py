...
class ReplicationLinksOperations:
    ...
    def _create_or_update_initial(
        ...
        database_name: str,
        link_id: str,
        parameters: Union[_models.ReplicationLink, IO],
        **kwargs: Any
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param link_id: Required.
        :type link_id: str
        :param parameters: Is either a ReplicationLink type or a IO type. Required.
        :type parameters: ~azure.mgmt.sql.models.ReplicationLink or IO
    ...
    def _update_initial(
        ...
        database_name: str,
        link_id: str,
        parameters: Union[_models.ReplicationLinkUpdate, IO],
        **kwargs: Any
    ) -> Optional[_models.ReplicationLink]:
        error_map = {
            401: ClientAuthenticationError,
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param link_id: Required.
        :type link_id: str
        :param parameters: Is either a ReplicationLinkUpdate type or a IO type. Required.
        :type parameters: ~azure.mgmt.sql.models.ReplicationLinkUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
