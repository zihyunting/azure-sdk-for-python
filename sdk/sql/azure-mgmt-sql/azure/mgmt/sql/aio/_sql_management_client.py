...
from .operations import (
    ...
    DatabaseBillingVersionOperations,
...
class SqlManagementClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :ivar database_billing_version: DatabaseBillingVersionOperations operations
    :vartype database_billing_version:
     azure.mgmt.sql.aio.operations.DatabaseBillingVersionOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.database_billing_version = DatabaseBillingVersionOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
