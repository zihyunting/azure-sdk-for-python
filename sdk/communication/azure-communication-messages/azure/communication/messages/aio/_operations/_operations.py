...
from ..._operations._operations import (
    ...
    build_notification_messages_post_message_request,
)
...
class NotificationMessagesClientOperationsMixin(NotificationMessagesClientMixinABC):  # pylint: disable=name-too-long
    ...
    @distributed_trace_async
    async def get_media(self, id: str, **kwargs: Any) -> bytes:
...
class MessageTemplateClientOperationsMixin(MessageTemplateClientMixinABC):
    ...
    def get_templates(
    ...
    ) -> AsyncIterable["_models.MessageTemplateResponse"]:
        # pylint: disable=line-too-long
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.communication.messages.models.MessageTemplateResponse]
        :raises ~azure.core.exceptions.HttpResponseError:
