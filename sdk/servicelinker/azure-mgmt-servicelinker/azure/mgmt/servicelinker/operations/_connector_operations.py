...
def build_list_dryrun_request(
    subscription_id: str, resource_group_name: str, location: str, **kwargs: Any
) -> HttpRequest:
...
def build_get_dryrun_request(
    subscription_id: str, resource_group_name: str, location: str, dryrun_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_create_dryrun_request(
    subscription_id: str, resource_group_name: str, location: str, dryrun_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_update_dryrun_request(
    subscription_id: str, resource_group_name: str, location: str, dryrun_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_dryrun_request(
    subscription_id: str, resource_group_name: str, location: str, dryrun_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_request(subscription_id: str, resource_group_name: str, location: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_get_request(
    subscription_id: str, resource_group_name: str, location: str, connector_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_generate_configurations_request(
    subscription_id: str, resource_group_name: str, location: str, connector_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ConnectorOperations:
    ...
    ) -> Iterable["_models.DryrunResource"]:
        """list dryrun jobs.
    ...
    def list(
        self, subscription_id: str, resource_group_name: str, location: str, **kwargs: Any
    ) -> Iterable["_models.LinkerResource"]:
