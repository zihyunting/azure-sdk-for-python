...
class IdentityClient:  # pylint: disable=client-accepts-api-version-keyword
    """IdentityClient.

    :ivar roles: RolesOperations operations
    :vartype roles: roles.aio.operations.RolesOperations
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        self._config = IdentityClientConfiguration(**kwargs)
