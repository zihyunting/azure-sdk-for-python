...
from ...operations._packages_operations import build_list_by_runtime_environment_request
...
class PackagesOperations:
    ...
    def list_by_runtime_environment(
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_runtime_environment_request(
                    resource_group_name=resource_group_name,
                    automation_account_name=automation_account_name,
                    runtime_environment_name=runtime_environment_name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
                    template_url=self.list_by_runtime_environment.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
    ...
    list_by_runtime_environment.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/runtimeEnvironments/{runtimeEnvironmentName}/packages"
    }
