...
class ContentLink(_serialization.Model):
    ...
    :ivar uri: Sets the uri of the content.
    :vartype uri: str
    :ivar content_hash: Sets the hash.
    :vartype content_hash: ~azure.mgmt.automation.models.ContentHash
    :ivar version: Sets the version of the content.
    :vartype version: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword uri: Sets the uri of the content.
        :paramtype uri: str
        :keyword content_hash: Sets the hash.
        :paramtype content_hash: ~azure.mgmt.automation.models.ContentHash
        :keyword version: Sets the version of the content.
...
class Module(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar location: The Azure Region where the resource lives.
    :vartype location: str
    :ivar etag: Gets the etag of the resource.
    :vartype etag: str
    :ivar is_global: Gets the isGlobal flag of the module.
    :vartype is_global: bool
    :ivar version: Gets the version of the module.
    :vartype version: str
    :ivar size_in_bytes: Gets the size in bytes of the module.
    :vartype size_in_bytes: int
    :ivar activity_count: Gets the activity count of the module.
    :vartype activity_count: int
    :ivar provisioning_state: Gets the provisioning state of the module. Known values are:
    ...
    :ivar error: Gets the error info of the module.
    ...
    :ivar description: Gets or sets the description.
    :vartype description: str
    :ivar is_composite: Gets type of module, if its composite or not.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword location: The Azure Region where the resource lives.
        :paramtype location: str
        :keyword etag: Gets the etag of the resource.
        :paramtype etag: str
        :keyword is_global: Gets the isGlobal flag of the module.
        :paramtype is_global: bool
        :keyword version: Gets the version of the module.
        :paramtype version: str
        :keyword size_in_bytes: Gets the size in bytes of the module.
        :paramtype size_in_bytes: int
        :keyword activity_count: Gets the activity count of the module.
        :paramtype activity_count: int
        :keyword provisioning_state: Gets the provisioning state of the module. Known values are:
         "Created", "Creating", "StartingImportModuleRunbook", "RunningImportModuleRunbook",
         "ContentRetrieved", "ContentDownloaded", "ContentValidated", "ConnectionTypeImported",
         "ContentStored", "ModuleDataStored", "ActivitiesStored", "ModuleImportRunbookComplete",
         "Succeeded", "Failed", "Canceled", and "Updating".
        ...
        :keyword error: Gets the error info of the module.
        :paramtype error: ~azure.mgmt.automation.models.ModuleErrorInfo
        :keyword creation_time: Gets the creation time.
        :paramtype creation_time: ~datetime.datetime
        :keyword last_modified_time: Gets the last modified time.
        :paramtype last_modified_time: ~datetime.datetime
        :keyword description: Gets or sets the description.
        :paramtype description: str
        :keyword is_composite: Gets type of module, if its composite or not.
...
class ModuleCreateOrUpdateParameters(_serialization.Model):
    ...
    :ivar name: Sets name of the resource.
    :vartype name: str
    :ivar location: Sets the location of the resource.
    :vartype location: str
    :ivar tags: Sets the tags attached to the resource.
    :vartype tags: dict[str, str]
    :ivar content_link: Sets the hash. Required.
    :vartype content_link: ~azure.mgmt.automation.models.ContentLink
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword name: Sets name of the resource.
        :paramtype name: str
        :keyword location: Sets the location of the resource.
        :paramtype location: str
        :keyword tags: Sets the tags attached to the resource.
        :paramtype tags: dict[str, str]
        :keyword content_link: Sets the hash. Required.
        :paramtype content_link: ~azure.mgmt.automation.models.ContentLink
        """
        super().__init__(**kwargs)
        self.name = name
...
class ModuleErrorInfo(_serialization.Model):
    ...
    def __init__(self, *, code: Optional[str] = None, message: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword code: Gets the error code.
        :paramtype code: str
        :keyword message: Gets the error message.
        :paramtype message: str
        """
        super().__init__(**kwargs)
        self.code = code
...
class ModuleListResult(_serialization.Model):
    ...
    :ivar value: Gets a list of modules.
    ...
    def __init__(
        ...
        """
        :keyword value: Gets a list of modules.
...
class ModuleUpdateParameters(_serialization.Model):
    ...
    :ivar tags: Sets the tags attached to the resource.
    :vartype tags: dict[str, str]
    :ivar content_link: Sets the module content link.
    :vartype content_link: ~azure.mgmt.automation.models.ContentLink
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword tags: Sets the tags attached to the resource.
        :paramtype tags: dict[str, str]
        :keyword content_link: Sets the module content link.
        :paramtype content_link: ~azure.mgmt.automation.models.ContentLink
        """
        super().__init__(**kwargs)
        self.name = None
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword runbook_type: Gets or sets the type of the runbook. Known values are: "Script",
         ...
         "Python2", "Python3", and "PowerShell72".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword runbook_type: Gets or sets the type of the runbook. Required. Known values are:
         ...
         "GraphPowerShell", "Python2", "Python3", and "PowerShell72".
        :paramtype runbook_type: str or ~azure.mgmt.automation.models.RunbookTypeEnum
