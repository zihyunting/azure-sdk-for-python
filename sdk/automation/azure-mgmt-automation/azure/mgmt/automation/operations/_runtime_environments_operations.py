...
class RuntimeEnvironmentsOperations:
    ...
    def update(
        ...
        automation_account_name: str,
        runtime_environment_name: str,
        parameters: Union[_models.RuntimeEnvironmentUpdateParameters, IO],
        **kwargs: Any
    ) -> _models.RuntimeEnvironment:
        """Update an Runtime Environment.
        ...
        :param parameters: Parameters supplied to the Runtime Environment. Is either a
         RuntimeEnvironmentUpdateParameters type or a IO type. Required.
        :type parameters: ~azure.mgmt.automation.models.RuntimeEnvironmentUpdateParameters or IO
        ...
        deserialized = self._deserialize("RuntimeEnvironment", pipeline_response)
    ...
    update.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/runtimeEnvironments/{runtimeEnvironmentName}"
    }
    ...
    def create(
        ...
        automation_account_name: str,
        runtime_environment_name: str,
        parameters: Union[_models.RuntimeEnvironment, IO],
        **kwargs: Any
    ) -> _models.RuntimeEnvironment:
        """Create or update Runtime Environment.
        ...
        :param parameters: Parameters supplied to the create  the runtime environment. Is either a
         RuntimeEnvironment type or a IO type. Required.
        :type parameters: ~azure.mgmt.automation.models.RuntimeEnvironment or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    list_by_automation_account.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/runtimeEnvironments"
    }
