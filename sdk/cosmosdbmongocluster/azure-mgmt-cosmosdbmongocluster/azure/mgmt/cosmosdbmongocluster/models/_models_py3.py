...
class Resource(_serialization.Model):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.cosmosdbmongocluster.models.SystemData
    """
...
class AzureResourceManagerPrivateEndpointConnection(ProxyResource):
    ...
    :vartype properties:
     ~azure.mgmt.cosmosdbmongocluster.models.PrivateEndpointConnectionProperties
    """
...
class CheckNameAvailabilityResponse(_serialization.Model):
    ...
    :ivar reason: The reason why the given name is not available. Known values are: "Invalid" and
     "AlreadyExists".
    :vartype reason: str or ~azure.mgmt.cosmosdbmongocluster.models.CheckNameAvailabilityReason
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword reason: The reason why the given name is not available. Known values are: "Invalid"
         and "AlreadyExists".
        :paramtype reason: str or ~azure.mgmt.cosmosdbmongocluster.models.CheckNameAvailabilityReason
...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.cosmosdbmongocluster.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info: list[~azure.mgmt.cosmosdbmongocluster.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.cosmosdbmongocluster.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.cosmosdbmongocluster.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
...
class FirewallRule(ProxyResource):
    ...
    :vartype properties: ~azure.mgmt.cosmosdbmongocluster.models.FirewallRuleProperties
    """
    ...
    def __init__(self, *, properties: Optional["_models.FirewallRuleProperties"] = None, **kwargs: Any) -> None:
        ...
        :paramtype properties: ~azure.mgmt.cosmosdbmongocluster.models.FirewallRuleProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
...
class FirewallRuleListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.cosmosdbmongocluster.models.FirewallRule]
    ...
    def __init__(self, *, value: List["_models.FirewallRule"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.cosmosdbmongocluster.models.FirewallRule]
...
class FirewallRuleProperties(_serialization.Model):
    ...
    :vartype provisioning_state: str or ~azure.mgmt.cosmosdbmongocluster.models.ProvisioningState
...
class ListConnectionStringsResult(_serialization.Model):
    ...
    :vartype connection_strings: list[~azure.mgmt.cosmosdbmongocluster.models.ConnectionString]
    """
...
class MongoCluster(TrackedResource):
    ...
    :vartype location: str
    :ivar properties: The resource-specific properties for this resource.
    :vartype properties: ~azure.mgmt.cosmosdbmongocluster.models.MongoClusterProperties
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype location: str
        :keyword properties: The resource-specific properties for this resource.
        :paramtype properties: ~azure.mgmt.cosmosdbmongocluster.models.MongoClusterProperties
        """
...
class MongoClusterListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.cosmosdbmongocluster.models.MongoCluster]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: List["_models.MongoCluster"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~azure.mgmt.cosmosdbmongocluster.models.MongoCluster]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class MongoClusterProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar create_mode: The mode to create a mongo cluster. Known values are: "Default" and
     "PointInTimeRestore".
    :vartype create_mode: str or ~azure.mgmt.cosmosdbmongocluster.models.CreateMode
    :ivar restore_parameters: The parameters to create a point-in-time restore mongo cluster.
    :vartype restore_parameters:
     ~azure.mgmt.cosmosdbmongocluster.models.MongoClusterRestoreParameters
    ...
    :vartype cluster_status: str or ~azure.mgmt.cosmosdbmongocluster.models.MongoClusterStatus
    ...
    :vartype public_network_access: str or
     ~azure.mgmt.cosmosdbmongocluster.models.PublicNetworkAccess
    :ivar node_group_specs: The list of node group specs in the cluster.
    :vartype node_group_specs: list[~azure.mgmt.cosmosdbmongocluster.models.NodeGroupSpec]
    :ivar private_endpoint_connections: List of private endpoint connections.
    :vartype private_endpoint_connections:
     list[~azure.mgmt.cosmosdbmongocluster.models.AzureResourceManagerPrivateEndpointConnection]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword create_mode: The mode to create a mongo cluster. Known values are: "Default" and
         "PointInTimeRestore".
        :paramtype create_mode: str or ~azure.mgmt.cosmosdbmongocluster.models.CreateMode
        ...
        :paramtype node_group_specs: list[~azure.mgmt.cosmosdbmongocluster.models.NodeGroupSpec]
        """
        super().__init__(**kwargs)
...
class MongoClusterUpdate(_serialization.Model):
    ...
    :vartype properties: ~azure.mgmt.cosmosdbmongocluster.models.MongoClusterUpdateProperties
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype properties: ~azure.mgmt.cosmosdbmongocluster.models.MongoClusterUpdateProperties
        """
        super().__init__(**kwargs)
        self.tags = tags
        self.properties = properties
...
class NodeGroupSpec(_serialization.Model):
    ...
    :vartype kind: str or ~azure.mgmt.cosmosdbmongocluster.models.NodeKind
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype kind: str or ~azure.mgmt.cosmosdbmongocluster.models.NodeKind
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.cosmosdbmongocluster.models.OperationDisplay
    :ivar origin: The intended executor of the operation; as in Resource Based Access Control
     (RBAC) and audit logs UX. Default value is "user,system". Known values are: "user", "system",
     and "user,system".
    :vartype origin: str or ~azure.mgmt.cosmosdbmongocluster.models.Origin
    :ivar action_type: Enum. Indicates the action type. "Internal" refers to actions that are for
     internal only APIs. "Internal"
    :vartype action_type: str or ~azure.mgmt.cosmosdbmongocluster.models.ActionType
    """
    ...
    def __init__(self, *, display: Optional["_models.OperationDisplay"] = None, **kwargs: Any) -> None:
        ...
        :paramtype display: ~azure.mgmt.cosmosdbmongocluster.models.OperationDisplay
        """
        super().__init__(**kwargs)
        self.name = None
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.cosmosdbmongocluster.models.Operation]
...
class PrivateEndpointConnectionProperties(_serialization.Model):
    ...
    :vartype private_endpoint: ~azure.mgmt.cosmosdbmongocluster.models.PrivateEndpoint
    :ivar private_link_service_connection_state: A collection of information about the state of the
     connection between service consumer and provider. Required.
    :vartype private_link_service_connection_state:
     ~azure.mgmt.cosmosdbmongocluster.models.PrivateLinkServiceConnectionState
    :ivar provisioning_state: The provisioning state of the private endpoint connection resource.
     Known values are: "Succeeded", "Creating", "Deleting", and "Failed".
    :vartype provisioning_state: str or
     ~azure.mgmt.cosmosdbmongocluster.models.PrivateEndpointConnectionProvisioningState
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype private_endpoint: ~azure.mgmt.cosmosdbmongocluster.models.PrivateEndpoint
...
class PrivateLinkServiceConnectionState(_serialization.Model):
    ...
    :vartype status: str or
     ~azure.mgmt.cosmosdbmongocluster.models.PrivateEndpointServiceConnectionStatus
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or ~azure.mgmt.cosmosdbmongocluster.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or ~azure.mgmt.cosmosdbmongocluster.models.CreatedByType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_by_type: The type of identity that created the resource. Known values are:
         "User", "Application", "ManagedIdentity", and "Key".
        :paramtype created_by_type: str or ~azure.mgmt.cosmosdbmongocluster.models.CreatedByType
        ...
        :paramtype last_modified_by_type: str or ~azure.mgmt.cosmosdbmongocluster.models.CreatedByType
