...
class FirewallRulesOperations:
    ...
    def list_by_mongo_cluster(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.cosmosdbmongocluster.models.FirewallRule]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either FirewallRule or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.cosmosdbmongocluster.models.FirewallRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
