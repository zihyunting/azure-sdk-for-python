...
class FirewallRulesOperations:
    ...
    def list_by_mongo_cluster(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cosmosdbmongocluster.models.FirewallRule]
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_by_mongo_cluster_request(
                    resource_group_name=resource_group_name,
                    mongo_cluster_name=mongo_cluster_name,
                    subscription_id=self._config.subscription_id,
                    api_version=api_version,
                    template_url=self.list_by_mongo_cluster.metadata["url"],
                    headers=_headers,
                    params=_params,
                )
    ...
    list_by_mongo_cluster.metadata = {
    ...
    async def get(
        ...
        :rtype: ~azure.mgmt.cosmosdbmongocluster.models.FirewallRule
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def _create_or_update_initial(
        ...
        resource: Union[_models.FirewallRule, IO],
        **kwargs: Any
    ) -> _models.FirewallRule:
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.cosmosdbmongocluster.models.FirewallRule
        ...
        :return: An instance of AsyncLROPoller that returns either FirewallRule or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.cosmosdbmongocluster.models.FirewallRule]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param firewall_rule_name: The name of the mongo cluster firewall rule. Required.
        :type firewall_rule_name: str
        :param resource: Resource create parameters. Is either a FirewallRule type or a IO type.
         Required.
        :type resource: ~azure.mgmt.cosmosdbmongocluster.models.FirewallRule or IO
