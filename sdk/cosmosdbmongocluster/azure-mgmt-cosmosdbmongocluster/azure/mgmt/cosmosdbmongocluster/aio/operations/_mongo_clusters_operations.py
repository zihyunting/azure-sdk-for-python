...
class MongoClustersOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.cosmosdbmongocluster.aio.CosmosDBMongoClusterManagementClient`'s
    ...
    async def check_name_availability(
        ...
        **kwargs: Any
        ...
        :type body: ~azure.mgmt.cosmosdbmongocluster.models.CheckNameAvailabilityRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: CheckNameAvailabilityResponse or the result of cls(response)
        :rtype: ~azure.mgmt.cosmosdbmongocluster.models.CheckNameAvailabilityResponse
    ...
    async def check_name_availability(
        ...
        :param body: The CheckAvailability request. Is either a CheckNameAvailabilityRequest type or a
         IO type. Required.
        :type body: ~azure.mgmt.cosmosdbmongocluster.models.CheckNameAvailabilityRequest or IO
    ...
    def list(self, **kwargs: Any) -> AsyncIterable["_models.MongoCluster"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cosmosdbmongocluster.models.MongoCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get(self, resource_group_name: str, mongo_cluster_name: str, **kwargs: Any) -> _models.MongoCluster:
        ...
        :rtype: ~azure.mgmt.cosmosdbmongocluster.models.MongoCluster
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def _create_or_update_initial(
        ...
        resource: Union[_models.MongoCluster, IO],
        **kwargs: Any
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type resource: ~azure.mgmt.cosmosdbmongocluster.models.MongoCluster
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        ...
        :return: An instance of AsyncLROPoller that returns either MongoCluster or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.cosmosdbmongocluster.models.MongoCluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param mongo_cluster_name: The name of the mongo cluster. Required.
        :type mongo_cluster_name: str
        :param resource: Resource create parameters. Is either a MongoCluster type or a IO type.
         Required.
        :type resource: ~azure.mgmt.cosmosdbmongocluster.models.MongoCluster or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        mongo_cluster_name: str,
        properties: Union[_models.MongoClusterUpdate, IO],
        **kwargs: Any
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.cosmosdbmongocluster.models.MongoClusterUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type properties: ~azure.mgmt.cosmosdbmongocluster.models.MongoClusterUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def list_connection_strings(
        ...
        :rtype: ~azure.mgmt.cosmosdbmongocluster.models.ListConnectionStringsResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
