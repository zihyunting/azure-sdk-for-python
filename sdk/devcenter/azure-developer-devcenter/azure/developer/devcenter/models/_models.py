...
class Catalog(_model_base.Model):
    ...
    :ivar uri: The unique URI of the catalog. Required.
    :vartype uri: str
    ...
    uri: str = rest_field()
    """The unique URI of the catalog. Required."""
...
class DevBox(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar uri: The unique URI of the dev box.
    :vartype uri: str
...
class DevBoxAction(_model_base.Model):
    ...
    :ivar uri: The unique URI for the Dev Box action.
    :vartype uri: str
    ...
    :ivar source_uri: The URI of the resource which triggered this action. Required.
    :vartype source_uri: str
    :ivar source_type: The type of the resource which triggered this action. Required. Known values
     are: "Pool" and "Schedule".
    :vartype source_type: str or ~azure.developer.devcenter.models.DevBoxActionSourceType
    ...
    source_uri: str = rest_field(name="sourceUri")
    """The URI of the resource which triggered this action. Required."""
    source_type: Union[str, "_models.DevBoxActionSourceType"] = rest_field(name="sourceType")
    """The type of the resource which triggered this action. Required. Known values are: \"Pool\" and
     \"Schedule\"."""
    ...
    def __init__(
        ...
        *,
        ...
        source_id: str,
        source_uri: str,
        source_type: Union[str, "_models.DevBoxActionSourceType"],
        uri: Optional[str] = None,
...
class DevBoxActionDelayResult(_model_base.Model):
    ...
    :ivar uri: The unique URI of the action.
    :vartype uri: str
    :ivar name: The name of the action. Required.
    :vartype name: str
...
class Environment(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar expiration_date: The time the expiration date will be triggered (UTC), after which the
     environment and associated resources will be deleted.
    :vartype expiration_date: ~datetime.datetime
    :ivar parameters: Parameters object for the environment.
    :vartype parameters: dict[str, any]
    :ivar uri: The unique URI of the environment. Required.
    :vartype uri: str
    ...
    expiration_date: Optional[datetime.datetime] = rest_field(name="expirationDate", format="rfc3339")
    """The time the expiration date will be triggered (UTC), after which the
     environment and associated resources will be deleted."""
    parameters: Optional[Dict[str, Any]] = rest_field()
    """Parameters object for the environment."""
    uri: str = rest_field()
    """The unique URI of the environment. Required."""
    name: str = rest_field(visibility=["read"])
...
class EnvironmentDefinition(_model_base.Model):
    ...
    :ivar uri: The unique URI of the environment definition. Required.
    :vartype uri: str
    ...
    uri: str = rest_field()
    """The unique URI of the environment definition. Required."""
    id: str = rest_field()
...
class EnvironmentType(_model_base.Model):
    ...
    :ivar uri: The unique URI of the environment type. Required.
    :vartype uri: str
    ...
    :ivar display_name: Display name of the environment type.
    :vartype display_name: str
    """

    uri: str = rest_field()
    """The unique URI of the environment type. Required."""
    name: str = rest_field()
...
class Pool(_model_base.Model):  # pylint: disable=too-many-instance-attributes
    """A pool of Dev Boxes.
    ...
    :ivar uri: The unique URI of the pool. Required.
    :vartype uri: str
    ...
    :ivar display_name: Display name of the pool.
    :vartype display_name: str
    """

    uri: str = rest_field()
    """The unique URI of the pool. Required."""
    name: str = rest_field(visibility=["read"])
    """Pool name. Required."""
...
class Project(_model_base.Model):
    ...
    :ivar uri: The unique URI of the project. Required.
    :vartype uri: str
    ...
    uri: str = rest_field()
    """The unique URI of the project. Required."""
    name: str = rest_field(visibility=["read"])
...
class Schedule(_model_base.Model):
    ...
    :ivar uri: The unique URI of the schedule. Required.
    :vartype uri: str
    :ivar name: Display name for the Schedule. Required.
    :vartype name: str
    :ivar source_uri: The URI of the resource that this schedule belongs to. Required.
    :vartype source_uri: str
    :ivar source_type: The type of the resource that this schedule belongs to. Required. "Pool"
    :vartype source_type: str or ~azure.developer.devcenter.models.ScheduleSourceType
    ...
    uri: str = rest_field()
    """The unique URI of the schedule. Required."""
    name: str = rest_field(visibility=["read"])
    """Display name for the Schedule. Required."""
    source_uri: str = rest_field(name="sourceUri")
    """The URI of the resource that this schedule belongs to. Required."""
    source_type: Union[str, "_models.ScheduleSourceType"] = rest_field(name="sourceType")
    """The type of the resource that this schedule belongs to. Required. \"Pool\""""
    ...
    def __init__(
        ...
        *,
        uri: str,
        source_uri: str,
        source_type: Union[str, "_models.ScheduleSourceType"],
