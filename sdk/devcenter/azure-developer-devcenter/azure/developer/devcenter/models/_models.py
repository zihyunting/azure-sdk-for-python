...
class Environment(_model_base.Model):
    ...
    parameters: Optional[bytes] = rest_field(format="base64")
...
class EnvironmentDefinitionParameter(_model_base.Model):
    ...
    default: Optional[bytes] = rest_field(format="base64")
...
class OperationDetails(_model_base.Model):
    ...
    properties: Optional[bytes] = rest_field(format="base64")
