...
class DevBoxesClientOperationsMixin(DevBoxesClientMixinABC):  # pylint: disable=too-many-public-methods
    ...
    async def get_dev_box(self, project_name: str, user_id: str, dev_box_name: str, **kwargs: Any) -> _models.DevBox:
        ...
        :param project_name: Name of the project. Required.
        :type project_name: str
        :param user_id: The AAD object id of the user. Required.
        :type user_id: str
    ...
    async def begin_create_dev_box(
        ...
        **kwargs: Any
        ...
        :type dev_box_name: str
        :param dev_box: Represents the body request of a Dev Box creation. Dev Box Pool name is
         required. Optionally set the owner of the Dev Box as local administrator. Required.
    ...
    async def begin_create_dev_box(
        ...
        **kwargs: Any
        ...
        :type dev_box_name: str
        :param dev_box: Represents the body request of a Dev Box creation. Dev Box Pool name is
         required. Optionally set the owner of the Dev Box as local administrator. Is one of the
         following types: DevBox, JSON, IO[bytes] Required.
            ...
            .. code-block:: python
                ...
                response == {
                    ...
                    "percentComplete": 0.0,  # Optional. Percent of the operation that is
                      complete.
                    "properties": bytes("bytes", encoding="utf-8"),  # Optional. Custom operation
                      properties, populated only for a successful operation.
        ...
        Example:
            .. code-block:: python
                ...
                response == {
                    ...
                    "parameters": bytes("bytes", encoding="utf-8"),  # Optional. Parameters
                    ...
                    "parameters": [
                        {
                            ...
                            "default": bytes("bytes", encoding="utf-8"),  # Optional.
