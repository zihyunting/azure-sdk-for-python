...
class NetworkManagementClient(
    ...
    :vartype list: azure.mgmt.network.v2023_11_01.aio.operations.ListOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.list = ListOperations(self._client, self._config, self._serialize, self._deserialize, "2023-11-01")
