...
class SimplifiedSolutionsOperations:
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        """Creates a simplified Solutions for the specific Azure resource or subscription using the inputs
        ‘solutionId and requiredInputs’ from discovery solutions. In the absence of the ‘Parameters’ it
        is likely that some of the simplified Solutions might fail execution, and you might see an
        empty response. :code:`<br/>`:code:`<br/>` :code:`<b>Note:</b>`  :code:`<br/>`1.
        ‘requiredInputs’ from Discovery solutions response must be passed via ‘parameters’ in the
        request body of simplified Solutions API. :code:`<br/>`.
