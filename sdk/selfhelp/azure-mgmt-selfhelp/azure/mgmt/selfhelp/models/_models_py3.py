...
class DiscoveryNlpRequest(_serialization.Model):
    ...
    :ivar issue_summary: Describe the issue with the affected resource.
    :vartype issue_summary: str
    :ivar resource_id: Provide resourceId of affected resource.
    :vartype resource_id: str
    :ivar service_id: Service Classification id for the resource. You can find required serviceId
     from Services API: https://learn.microsoft.com/rest/api/support/services/list?tabs=HTTP Service
     Id is the GUID which can be found under name field in Services List response.
    :vartype service_id: str
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword issue_summary: Describe the issue with the affected resource.
        :paramtype issue_summary: str
        :keyword resource_id: Provide resourceId of affected resource.
        :paramtype resource_id: str
        :keyword service_id: Service Classification id for the resource. You can find required
         serviceId from Services API:
         https://learn.microsoft.com/rest/api/support/services/list?tabs=HTTP Service Id is the GUID
         which can be found under name field in Services List response.
...
class SolutionNlpMetadataResource(ProxyResource):
    ...
    :ivar system_data: Azure Resource Manager metadata containing createdBy and modifiedBy
     information.
    :vartype system_data: ~azure.mgmt.selfhelp.models.SystemData
    :ivar problem_title: Title for given ProblemClassificationId.
    :vartype problem_title: str
    :ivar problem_description: Description for given ProblemClassificationId.
    :vartype problem_description: str
    :ivar service_id: Service resource id that is having the problem.
    :vartype service_id: str
    :ivar problem_classification_id: Problem Classification Id that is having the issue.
    :vartype problem_classification_id: str
    :ivar solutions: The list of solution metadata.
    :vartype solutions: list[~azure.mgmt.selfhelp.models.SolutionMetadataProperties]
    :ivar related_services: The list of solution metadata.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword problem_title: Title for given ProblemClassificationId.
        :paramtype problem_title: str
        :keyword problem_description: Description for given ProblemClassificationId.
        :paramtype problem_description: str
        :keyword service_id: Service resource id that is having the problem.
        :paramtype service_id: str
        :keyword problem_classification_id: Problem Classification Id that is having the issue.
        :paramtype problem_classification_id: str
        :keyword solutions: The list of solution metadata.
        :paramtype solutions: list[~azure.mgmt.selfhelp.models.SolutionMetadataProperties]
        :keyword related_services: The list of solution metadata.
