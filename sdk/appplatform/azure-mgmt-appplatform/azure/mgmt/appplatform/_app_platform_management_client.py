...
class AppPlatformManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    def job(self):
        """Instance depends on the API version:
           ...
           * 2024-01-01-preview: :class:`JobOperations<azure.mgmt.appplatform.v2024_01_01_preview.operations.JobOperations>`
        """
        api_version = self._get_api_version('job')
        if api_version == '2024-01-01-preview':
            from .v2024_01_01_preview.operations import JobOperations as OperationClass
        else:
