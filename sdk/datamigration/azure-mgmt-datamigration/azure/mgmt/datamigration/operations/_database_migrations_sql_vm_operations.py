...
def build_get_request(
    ...
    **kwargs: Any
    ...
    )  # type: Literal["2022-10-31-preview"]
...
class DatabaseMigrationsSqlVmOperations:
    ...
    _delete_initial.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SqlVirtualMachine/sqlVirtualMachines/{sqlVirtualMachineName}/providers/Microsoft.DataMigration/databaseMigrations/{targetDbName}"}  # type: ignore
    ...
    begin_delete.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SqlVirtualMachine/sqlVirtualMachines/{sqlVirtualMachineName}/providers/Microsoft.DataMigration/databaseMigrations/{targetDbName}"}  # type: ignore

    @distributed_trace
    def list_by_scope(
        self, resource_group_name: str, sql_virtual_machine_name: str, **kwargs: Any
    ) -> _models.DatabaseMigrationSqlVmListResult:
        ...
        :type sql_virtual_machine_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DatabaseMigrationSqlVmListResult or the result of cls(response)
        :rtype: ~azure.mgmt.datamigration.models.DatabaseMigrationSqlVmListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.DatabaseMigrationSqlVmListResult]
        ...
        deserialized = self._deserialize("DatabaseMigrationSqlVmListResult", pipeline_response)
    ...
    list_by_scope.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SqlVirtualMachine/sqlVirtualMachines/{sqlVirtualMachineName}/providers/Microsoft.DataMigration/databaseMigrations"}  # type: ignore
