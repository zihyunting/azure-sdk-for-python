...
class DatabaseMigrationsSqlMiOperations:
    ...
    _delete_initial.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/providers/Microsoft.DataMigration/databaseMigrations/{targetDbName}"}  # type: ignore
    ...
    begin_delete.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/providers/Microsoft.DataMigration/databaseMigrations/{targetDbName}"}  # type: ignore

    @distributed_trace
    def list_by_scope(
        self, resource_group_name: str, managed_instance_name: str, **kwargs: Any
    ) -> _models.DatabaseMigrationSqlMiListResult:
        ...
        :type managed_instance_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DatabaseMigrationSqlMiListResult or the result of cls(response)
        :rtype: ~azure.mgmt.datamigration.models.DatabaseMigrationSqlMiListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.DatabaseMigrationSqlMiListResult]
        ...
        deserialized = self._deserialize("DatabaseMigrationSqlMiListResult", pipeline_response)
    ...
    list_by_scope.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/providers/Microsoft.DataMigration/databaseMigrations"}  # type: ignore
