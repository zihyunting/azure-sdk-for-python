...
class DatabaseMigrationProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar kind: Required. Known values are: "SqlMi" and "SqlVm".
    ...
    _subtype_map = {"kind": {"SqlMi": "DatabaseMigrationPropertiesSqlMi", "SqlVm": "DatabaseMigrationPropertiesSqlVm"}}
...
class DatabaseMigrationSqlDb(ProxyResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar type:
    :vartype type: str
    :ivar location: Location of database migration service.
    ...
    :ivar sql_data_copy_thresholds: Minimum Row count and size of a table with a clustered index
     required to perform parallel data copy.
    :vartype sql_data_copy_thresholds: ~azure.mgmt.datamigration.models.SqlDataCopyThresholds
    :ivar offline_configuration: Offline configuration.
    :vartype offline_configuration: ~azure.mgmt.datamigration.models.SqlDbOfflineConfiguration
    :ivar backup_configuration: Source Location details of backups.
    :vartype backup_configuration: ~azure.mgmt.datamigration.models.SqlDbBackupConfiguration
    :ivar table_list: List of tables to copy.
    :vartype table_list: list[str]
    :ivar scope: Scope of the database.
    :vartype scope: str
    :ivar provisioning_state: Provisioning State of migration. ProvisioningState as Succeeded
     implies that validations have been performed and migration has started.
    :vartype provisioning_state: str
    ...
    :vartype kind: str or ~azure.mgmt.datamigration.models.DatabaseMigrationPropertiesSqlDbKind
    ...
    _validation = {
        ...
        "system_data": {"readonly": True},
        "migration_status_details": {"readonly": True},
        "sql_data_copy_thresholds": {"readonly": True},
        "offline_configuration": {"readonly": True},
        "backup_configuration": {"readonly": True},
        "provisioning_state": {"readonly": True},
        "migration_status": {"readonly": True},
        "started_on": {"readonly": True},
        "ended_on": {"readonly": True},
    ...
    _attribute_map = {
        ...
        "system_data": {"key": "systemData", "type": "SystemData"},
        "migration_status_details": {"key": "properties.migrationStatusDetails", "type": "SqlDbMigrationStatusDetails"},
        "target_sql_connection": {"key": "properties.targetSqlConnection", "type": "SqlConnectionInformation"},
        "sql_data_copy_thresholds": {"key": "properties.sqlDataCopyThresholds", "type": "SqlDataCopyThresholds"},
        "offline_configuration": {"key": "properties.offlineConfiguration", "type": "SqlDbOfflineConfiguration"},
        "backup_configuration": {"key": "properties.backupConfiguration", "type": "SqlDbBackupConfiguration"},
        "table_list": {"key": "properties.tableList", "type": "[str]"},
        ...
        "source_sql_connection": {"key": "properties.sourceSqlConnection", "type": "SqlConnectionInformation"},
        ...
        "target_database_collation": {"key": "properties.targetDatabaseCollation", "type": "str"},
        ...
        "key_vault": {"key": "properties.keyVault", "type": "KeyVaultProperties"},
    }
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        migration_operation_id: Optional[str] = None,
        provisioning_error: Optional[str] = None,
        kind: Optional[Union[str, "_models.DatabaseMigrationPropertiesSqlDbKind"]] = None,
        key_vault: Optional["_models.KeyVaultProperties"] = None,
        **kwargs
    ):
        """
        :keyword location: Location of database migration service.
        ...
        :keyword scope: Scope of the database.
        :paramtype scope: str
        :keyword source_sql_connection: Source SQL Server connection details.
        :paramtype source_sql_connection: ~azure.mgmt.datamigration.models.SqlConnectionInformation
        :keyword source_database_name: Name of the source database.
        ...
        :paramtype kind: str or ~azure.mgmt.datamigration.models.DatabaseMigrationPropertiesSqlDbKind
        ...
        self.sql_data_copy_thresholds = None
...
class DatabaseMigrationSqlMiListResult(_serialization.Model):
    """A list of Database Migrations for SQL Managed Instance.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar value:
    :vartype value: list[~azure.mgmt.datamigration.models.DatabaseMigrationSqlMi]
    :ivar next_link:
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[DatabaseMigrationSqlMi]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }
...
class DatabaseMigrationSqlVmListResult(_serialization.Model):
    """A list of Database Migrations for SQL Virtual Machine.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar value:
    :vartype value: list[~azure.mgmt.datamigration.models.DatabaseMigrationSqlVm]
    :ivar next_link:
    :vartype next_link: str
    """
    ...
    _attribute_map = {
        "value": {"key": "value", "type": "[DatabaseMigrationSqlVm]"},
        "next_link": {"key": "nextLink", "type": "str"},
    }
...
class SqlDataCopyThresholds(_serialization.Model):
    """Minimum Row count and size of a table with a clustered index required to perform parallel data copy.

    :ivar cidx_row_threshold: Minimum row count of a table with clustered index to perform parallel
     data copy.
    :vartype cidx_row_threshold: int
    :ivar cidx_kbs_threshold: Minimum required size in kbs of a table with a clustered index to
     perform parallel data copy.
    :vartype cidx_kbs_threshold: int
    """

    _attribute_map = {
        "cidx_row_threshold": {"key": "cidxRowThreshold", "type": "int"},
        "cidx_kbs_threshold": {"key": "cidxKbsThreshold", "type": "int"},
    }

    def __init__(self, *, cidx_row_threshold: Optional[int] = None, cidx_kbs_threshold: Optional[int] = None, **kwargs):
        """
        :keyword cidx_row_threshold: Minimum row count of a table with clustered index to perform
         parallel data copy.
        :paramtype cidx_row_threshold: int
        :keyword cidx_kbs_threshold: Minimum required size in kbs of a table with a clustered index to
         perform parallel data copy.
        :paramtype cidx_kbs_threshold: int
        """
        super().__init__(**kwargs)
        self.cidx_row_threshold = cidx_row_threshold
        self.cidx_kbs_threshold = cidx_kbs_threshold


class SqlDbBackupConfiguration(_serialization.Model):
    """Backup Configuration.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar source_location: Source location of backups.
    :vartype source_location: ~azure.mgmt.datamigration.models.SqlDbSourceBackupLocation
    """
    ...
    _attribute_map = {
        "source_location": {"key": "sourceLocation", "type": "SqlDbSourceBackupLocation"},
    }
...
class SqlDbSourceBackupLocation(_serialization.Model):
    """Source Location details of backups.
