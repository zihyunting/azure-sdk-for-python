...
class EventGridClientOperationsMixin(EventGridClientMixinABC):
    @distributed_trace
    def publish_cloud_event(self, topic_name: str, event: _models.CloudEvent, **kwargs: Any) -> _models.PublishResult:
        ...
        cls: ClsType[_models.PublishResult] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.PublishResult, response.json())
